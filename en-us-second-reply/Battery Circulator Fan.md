...
We apologize for any inconvenience caused.
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. A screenshot showing the child lock settings by going to the SwitchBot app → Circulator Fan → Gear icon → Child Lock.
  2. Video of the circulator not oscillating even when the oscillation button on the control panel is pressed
...
We apologize for any inconvenience caused.
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. A video shows that the battery indicator on the main unit does not light up or the battery cage does not increase when the power cable is connected

1. Also, if the replacement service is needed, to expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
- Phone Number
...
Thank you for reporting this issue.
We apologize for any inconvenience caused.
Since the blade part cannot be replaced separately, we will replace the entire Circulator Fan if it is within the warranty period. To expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
- Phone Number
...
We apologize for any inconvenience caused.
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. A video showing that the Battery Circulator Fan does not return to a level, straight-ahead position when turned off.
  2. A screenshot of the Auto-Align Front setting in the SwitchBot app
...
Thank you for reporting this issue.
We apologize for any inconvenience caused.
We will arrange a replacement for you under the warranty. To expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
- Phone Number
