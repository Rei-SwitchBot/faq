...
- A video demonstrating the inability to unlock the door lock using palm vein recognition
...
To better understand the situation, we would appreciate it if you could share a video showing the problem. 
  1. A video showing the Keypad Vision Pro indicator lamp status while scanning SwitchBot NFC card.
...
Thank you for the information provided.
Sorry for any inconvenience caused.
To better assist you, we would appreciate it if you could share the following information:
- A video demonstrating the device's indicator status being verified by approaching your Keypad Vision Pro

After investigation, if it is necessary to send accessories or replace the product, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
- Phone Number
...
Sorry for any inconvenience caused.
We will forward your feedback to our R&D team for further investigation, and would appreciate it if you could share the following information:
Which transportation IC card are you using
