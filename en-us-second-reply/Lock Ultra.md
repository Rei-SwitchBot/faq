...
---
### Troubleshooting the Settings Screen of SwitchBot Lock Ultra Does Not Have the Night-Latch Option
...
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. The rotation angle of the front door lock
  2. Number of lock/unlock actions per day
  3. Screenshot of low battery status
...
Sorry for any inconvenience caused.
We will forward your feedback to our R&D team for further investigation, and would appreciate it if you could share the following information:
- Screen recording demonstrating the inability to set dual lock
...
We apologize for any inconvenience caused.
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. A video showing the Lock Ultra not rotating while using the emergency unlock feature.
2. Also, if the replacement service is needed, to expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
