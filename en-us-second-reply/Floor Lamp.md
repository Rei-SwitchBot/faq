...
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. A video of the Floor Lamp not turning on even when plugged into an outlet
  2. A photo showing the connection between the controller and the Floor Lamp terminals
...
Thank you for reporting this issue. 
We apologize for any inconvenience caused.
After confirming, it seems there may be a hardware issue with the floor lamp. We'd like to send you a replacement if it is under warranty. To expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
- Phone Number
...
- Distance between the Floor Lamp and the router
...
---
### Troubleshooting Can't Control SwitchBot Floor Lamp With the Controller.
