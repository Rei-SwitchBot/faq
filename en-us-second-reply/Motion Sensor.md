...
When the batteries are inserted, the Motion Sensor indicator blinks once according to the device's specifications. To determine if your device needs to be replaced, could you kindly provide the following information?
...
---
### Troubleshooting SwitchBot Motion Sensor Failing to Connect the Hub
