...
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  1. A video demonstrating that pressing the button on the side of the PlugMini does not turn it off
...
We apologize for any inconvenience caused.
1. To determine if your device needs to be replaced, could you kindly provide the following information?
  - A video demonstrating that the Plug Mini does not respond when the power button is held down for 15 seconds.
2. Also, if the replacement service is needed, to expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
- Purchase channel
- Order ID
- Recipient Full Name
