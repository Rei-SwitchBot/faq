...
1. You can pair your Lock with the Keypad Vision in the following order:
...
2. To enable communication between the Keypad Vision and the lock product, go to the SwitchBot App -> Keypad Vision -> Gear Icon -> Turn on Fast Unlock. This setting ensures that after manually locking the door, the status will be synced to the Keypad Vision via Bluetooth. Your Lock will not unlock during sleep mode, even if your face is scanned.
3. If the problem persists, consider setting activation times for your Keypad Vision by navigating to SwitchBot App -> Keypad Vision -> Gear Icon -> Face Entry Settings -> Trigger Face Recognition -> Custom. Once you set a custom activation time, the Keypad Vision will automatically activate when your face is scanned during that time. Outside this specified time, you will need to manually activate the device.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Please check for available firmware updates by going to SwitchBot app → Keypad Vision → Gear icon → Firmware & Battery. If an update is available, perform it near the device.
...
---
### Is It Possible to Add the Password for SwitchBot Keypad Vision Remotely?

When the Keypad Vision is installed within the Bluetooth range of the hub, it will automatically connect to the hub and network. Once networked, you can remotely add or delete passwords.  
Note:
...
---
### Can I Set up My Echo Show to Alert Me with a Sound When SwitchBot Keypad Vision Button Is Pressed?

We regret to inform you that SwitchBot Keypad Vision cannot be integrated with third-party services such as Alexa or Google Home. We apologize for any inconvenience this may cause. Please rest assured that we will take your feedback into consideration for future product improvements.
We would like to present the following two alternatives for your consideration.
1. After linking the Hub 3 or Lock Ultra to the button on the Keypad Vision, pressing the button will trigger a sound from the Hub 3 or Lock Ultra.
2. By introducing SwitchBot Smart Video Doorbell, a sound will play from the Alexa smart speaker when the doorbell is pressed.


---
### How to Remove SwitchBot Keypad Vision

1. Remove the Keypad Vision body from the mounting kit.
...
5. If the mounting kit is damaged during the Keypad Vision removal process, please submit feedback through the SwitchBot app to request replacement parts.
...
---
### If I Place the NFC Card Inside an RFID-Blocking Wallet, Can I Unlock the Door Lock by Holding the Wallet Close to SwitchBot Keypad Vision?
...
---
### How Many Faces Can I Add to SwitchBot Keypad Vision?

SwitchBot Keypad Vision can currently store up to 100 faces.
...
3. Turn off the Keypad Vision's power switch, then turn it back on.
