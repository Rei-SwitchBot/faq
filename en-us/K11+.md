...
Video: [https://youtu.be/KSgSbyqlNEI](https://youtu.be/KSgSbyqlNEI)
Note: The following video is for the K10+, but the cleaning procedure also applies to the K11+.
3. Replace the dust bag.



---
### Troubleshooting: SwitchBot Robot Vacuum K11+ Keeps Reporting "Main Brush Stuck" and Fails to Clean
...
<img width="960" height="1280" alt="image" src="https://github.com/user-attachments/assets/cce74f7f-6232-4750-be4f-db944bc53d5c" />

2. Remove the main brush and brush frame, then run the robot to check if the same error persists.
3. Remove the main brush and manually clean any foreign materials such as hair.
...
---
### Troubleshooting: The Main Brush of SwitchBot Robot Vacuum K11+ Has Stopped Rotating.
...
<img width="960" height="1280" alt="image" src="https://github.com/user-attachments/assets/f6c8031f-f302-44ed-87fa-6e77a8887cc0" />
...
---
### Troubleshooting: The Mopping Progress Was Reset After Replacing the Mopping Sheet During a Cleaning Task.

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
After checking the situation, it is possible that the cleaning task may have been ended unintentionally while the mopping sheet was being replaced.
The next time you replace the mopping sheet during a cleaning task, please try the following steps:
1. Pause the cleaning task in the SwitchBot app, or by pressing the cleaning button on the robot vacuum.
2. Replace the mopping sheet.
...
---
### Troubleshooting: SwitchBot Robot Vacuum K11+ Misses Some Areas While Cleaning

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
Please delete the current map, create a new map, and then test the cleaning performance again.

---
### Troubleshooting: SwitchBot Robot Vacuum K11+ Occasionally Disappears from the SwitchBot App
