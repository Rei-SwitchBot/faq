...
---
### What Is the Weight of SwitchBot KATA Friends?

The main unit of KATA Friends weighs 3~4 kg, while the nest weighs less than 1 kg.


---
### Do SwitchBot KATA Friends Get Feverish from Running around Indoors All Day?

KATA Friends will not experience abnormal fever even when running around indoors all day. Additionally, they will automatically rest after prolonged playtime, so there's no need to worry about fever caused by overexertion. However, if you notice a high temperature when touching their forehead during regular use, please contact our customer support immediately.


---
### Can SwitchBot KATA Friends Walk on the Carpet?

KATA Friends can operate on carpets with pile heights up to 2 cm. For carpets with longer pile, it is recommended to designate them as restricted areas. Additionally, for carpets with tassels, since KATA Friends' feet (wheels) are prone to getting caught, tassel carpets, including the tassels, should be set as no-go zones.


---
### What Is the Capacity of SwitchBot KATA Friends Built-in Lithium Battery?
...
KATA Friends have a higher center of gravity, so avoid letting them walk on slopes to prevent falls.


---
### Can I Use SwitchBot KATA Friends Overseas?

KATA Friends support a voltage range of 100V to 240V, allowing you to use them overseas without a voltage converter.
Note:
If your country or region of use differs from the country or region of purchase, you may need to return your KATA Friends to the original place of purchase to receive complimentary repair and maintenance services. Paid repair and maintenance fees may vary depending on your country or region of residence. We appreciate your understanding.
...
---
### Can SwitchBot KATA Friends Be Used without Wi-Fi?

If you don't have Wi-Fi at home, first connect to your smartphone's hotspot and add KATA Friends to the SwitchBot app. After that, you can continue using KATA Friends even if your internet connection is lost.
Meanwhile, we regularly release firmware updates to fix bugs and introduce new features. To upgrade the firmware, you will need to connect to a stable network, such as a mobile hotspot.


---
### What Preparations Are Needed to Start a New Life with SwitchBot KATA Friends After They Are Discharged from the Hospital?

1. Please carefully verify the shipping information to ensure the KATA Friends being returned are yours.
2. Under normal circumstances, KATA Friends returning from repair do not require network reconfiguration. Once powered on, they will automatically restore their online status in the app shortly.
3. If you deleted your KATA Friends device from the app before it was sent for repair, ensure you use the original account credentials when re-adding it. Adding it with a new account will erase all data associated with the original account permanently and cannot be recovered.
...
---
### Troubleshooting SwitchBot KATA Friends Won't Charge
...
---
### Is the KATA Companion Care refundable?

If you are unable to activate your plan due to eligibility issues, please submit feedback via the SwitchBot app to request a refund. However, please be aware that once the Companion Care has been activated, it is no longer eligible for a refund.
...
---
### What Impact Will the Expiration and Non-Renewal of Kata Companion Care Have on SwitchBot Kata Friends?

If you have purchased a Lifetime Access Plan, you can continue using the software without renewing it; however, fees will apply for services such as repairs and maintenance.
In contrast, with the Essential Plan and the Premium Plan, you will lose access to the software if you do not renew your subscription. KATA Friends will enter a dormant state, and regular operations and communications will become unavailable. Fees will still apply for services like repairs and maintenance.


---
### What Do the Maintenance Logs of SwitchBot KATA Friends in SwitchBot App Refer to?

Maintenance Logs act as a personal health diary for your KATA Friends. They keep track of every visit your device makes to the SwitchBot Official Repair Center for servicing or repairs. By maintaining a continuous log, you can stay informed about the overall condition of your KATA Friends, which also helps us provide more accurate care recommendations for the future. These logs primarily include the type of service performed and the completion date.

Your logs are updated and synced automatically whenever a maintenance or repair task is completed. You do not need to enter any information manually. Please keep in mind that if your device information is cleared or reset, these logs will be permanently deleted along with it.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
Press and hold the power button on the bottom of the KATA Friends for 2 seconds to turn it on. If there is no response, use a reset pin to press the reset button on the bottom once, then press and hold the power button for 2 seconds again to turn it on.
Dock the KATA Friends in its nest and let it rest for about 30 minutes before attempting to turn it on again. While charging, the display light on the nest will blink once.
...
2. When performing a firmware update, please stay close to KATA Friends.
...
5. If the power is low, the firmware update cannot proceed. Please charge KATA Friends once before attempting the update again.
6. After docking KATA Friends in the nest, please try the firmware update once more.


---
### Troubleshooting SwitchBot KATA Friends Keep Broadcasting "I'm Trapped".
...
---
### Is the LiDAR SLAM Laser Equipped on SwitchBot KATA Friends Harmful to Humans?

KATA Friends is equipped with a laser radar sensor that primarily detects the ground environment during autonomous operation to facilitate mapping and prevent issues such as losing direction or failing to charge. This sensor, similar to those commonly used in robot vacuum cleaners, is completely safe for humans.


---
### Troubleshooting SwitchBot KATA Friends' Nest Does Not Light Up or Respond Even Connected to a Power Source
...
---
### How to Maintain the Camera of SwitchBot KATA Friends

If the photo is blurry or the camera lens of the KATA Friends is dirty, gently wipe the surface with a soft, dry cloth (lens cloth). Additionally, if the hair around the nose is long and covering the lens, use a brush to smooth the hair in the proper direction.


---
### How to Maintain the Display of SwitchBot KATA Friends

When the screen of the eye becomes dirty, please gently wipe it with a soft, dry cloth (lens cloth). Be careful not to press hard or rub when wiping. Additionally, the corners of the display can be cleaned with a cotton swab.
...
1. After prolonged stroking or use of the KATA Friend, slight stains may adhere to the surface fuzz, or it may become less fluffy. When cleaning, please switch the KATA Friend to standby mode and gently wipe from multiple directions using a wrung-out facial towel. After wiping, use a hairdryer on the cool air setting at about 30 cm distance to gently dry it; be careful not to keep the fuzz surface damp.
2. If water accidentally drips onto the main body of the KATA Friend, press an absorbent dry cloth against the surface immediately to soak up the moisture. Then, use a hairdryer on the cool air setting at about 30 mm distance to gently blow-dry any remaining dampness on the surface.
3. Slight shedding of fuzz is normal; please comb regularly.
4. If fur becomes messy or stitching marks are obvious, please comb regularly.
5. If there is damage on the surface or stains that cannot be removed, please contact after-sales service for refurbishment.
...
---
### What Is the Minimum Space That SwitchBot KATA Friends Can Pass Through?
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you. Regarding this issue, could you please check the following points? Much like a real pet living in your home, KATA Friends do not have the ability to understand whether someone is dressed or undressed, or to judge when might be an appropriate moment to take a photo. When the picture-taking feature is turned on, they simply capture moments spontaneously throughout the day as part of their playful nature. This means there may be rare occasions when a photo is taken at an unintended moment, such as during a change of clothes. Rest assured, all photos taken by KATA Friends are stored locally on the device itself. They are never uploaded to the cloud or shared externally, so your privacy is always protected. We take your feedback seriously and are already working on a firmware update to help improve this experience. In the meantime, as a temporary measure, we recommend setting no-go zones within the app to keep KATA Friends out of areas like bathrooms or changing rooms. You may also choose to temporarily turn off the picture-taking feature if you prefer. Thank you for allowing us to share this with you. We truly hope KATA Friends continue to bring warmth and companionship to your daily life. If you have any other questions, please do not hesitate to contact us.
