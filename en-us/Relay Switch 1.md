...
---
### Can I Use SwitchBot Relay Switch 1 to Control the Air Conditioner Remotely?

Last Updated: 2024 Oct 30

Related Product: SwitchBot Relay Switch 1

We do not recommend using SwitchBot Relay Switch to control an air conditioner. Although most air conditioners operate at around 3.5A during regular use, the initial motor startup can draw a surge current between 11-18A (3-8 times the rated current).
...
---
### Can SwitchBot Relay Switch 1 Be Used Outdoors?
...
---
### Can SwitchBot Relay Switch 1 Measure DC Loads?
...
---
### Devices Are Compatible with Matter via SwitchBot Relay Switch 1
...
---
### Does SwitchBot Relay Switch 1 Require a Neutral Wire?
...
---
### Over-Temperature Protection in SwitchBot Relay Switch 1
...
---
### Power Consumption of SwitchBot Relay Switch 1
...
---
### Use SwitchBot Relay Switch 1 as a Lightweight Gateway for SwitchBot BLE Devices
