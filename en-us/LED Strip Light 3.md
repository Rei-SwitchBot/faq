...
---
### Troubleshooting A Section of SwitchBot LED Strip Light 3 Is Not Working

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please provide a photo or video showing the issue?
...
---
### When the Scene and Automation Actions Are Set to Turn On SwitchBot LED Strip Light 3, Can I Confirm Which Color It Is Set to Through the Displayed Icon?
...
---
### Troubleshooting SwitchBot LED Strip Light 3 Schedule Won't Work
...
---
### Troubleshooting Can't Control SwitchBot LED Strip Light 3 With the Controller.
...
---
### Can SwitchBot LED Strip Light 3 Be Extended for Use?

Since the connection points or even the entire LED Strip Light 3 may fail to illuminate, please avoid extending the light strip.

---
### Can I Cut SwitchBot LED Strip Light 3 and Reuse the Remaining?
...
---
### Can Multiple SwitchBot LED Strip Light 3s Be Used as a Group?

SwitchBot LED Strip Light 3 does not support a grouping feature. However, you can achieve similar results by adding multiple devices as actions within a SwitchBot Scene or Automation, allowing them to follow the same command. Please note that due to network connectivity, these commands may occasionally execute with a slight delay, meaning the devices might not operate perfectly in sync (for example, turning on or off at the exact same time). We appreciate your understanding.
