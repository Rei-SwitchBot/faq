...
Please scroll down to the bottom of this page for more language options.

We released new cloud storage subscription plans in our app for our camera products on Mar 15, 2023.

Current Subscription Plans

The subscription plans below are applicable to Indoor Cam, Pan/Tilt Cam and Pan/Tilt Cam 2K.
...
Event recording for the past 30 days
...
The new subscription plans listed below are applicable to

all SwitchBot cameras.
...
[SwitchBot Camera Cloud Storage Service User Agreement](https://support.switch-bot.com/hc/en-us/articles/13126332972695)

for more information.

Will I be charged differently for my auto-renewal subscription as the price of your subscription plans change?

No. Unless you actively unsubscribe and re-subscribe to a new subscription plan under cloud storage services, your account will always be charged at the same price as it has been previously.

I've already purchased an annual subscription plan. Can I refund this now that these new subscription plans are out?

Unfortunately not. All annual subscription plans are signed up for a minimum period of 365 days, once this plan is in effect, it cannot be refunded in full or in part. We recommend that you subscribe to a new subscription plan at the end of your service cycle. For more information regarding your annual subscription plan, please contact our Customer Support Team.

Will my recordings stored in cloud be lost once I changed to a new subscription plan?

No. Your cloud recordings will not be lost as long as the subscription plan you purchased for your camera is still in its valid period. If you have more concerns, please contact our Customer Support Team.

I have several Homes in SwitchBot App. Can I use the cloud storage subscriptions across different Homes?

No. The cloud storage subscriptions are not transferable across different homes. This means that you can only use your subscription service

within

the home where the camera you paid for is located. Alternatively, You might consider moving the camera to the home with existing cloud storage subscriptions.

Can I Freely Assign Cloud Storage to Any Camera After Purchasing a Multi-Device Cloud Storage Plan?

If your cameras are from the same series, you can freely assign the cloud storage plan to any camera within that series. However, you cannot assign cloud storage plans across different series of cameras.

Camera Series:

Series A: SwitchBot Indoor Cam, SwitchBot Pan/Tilt Cam, SwitchBot Pan/Tilt Cam 2K, SwitchBot Outdoor Spotlight Cam, SwitchBot Outdoor Spotlight Cam 2K

Series B: SwitchBot Pan/Tilt Cam Plus 2K, SwitchBot Pan/Tilt Cam Plus 3K

Example:

If you own both an Outdoor Spotlight Cam (from Series A) and a Pan/Tilt Cam Plus 2K (from Series B), you'll need to purchase separate cloud storage plans for each series. This means that if you purchase two-devices supported plan under Pan/Tilt Cam Plus 2K, it cannot be used for the Outdoor Spotlight Cam.
...
For EU customers, please refer to

[Updates to our Cloud Storage plans! (For EU customers)](https://support.switch-bot.com/hc/en-us/articles/13125648433943)

.

For UK customers, please refer to

[Updates to our Cloud Storage plans! (For UK customers)](https://support.switch-bot.com/hc/en-us/articles/12649891419671)
...
The new subscription plans listed below are applicable to all SwitchBot cameras.
