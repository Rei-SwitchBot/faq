...
2. Make sure your appliance and IR remote controllers are NOT marked with any Bluetooth logo
...
Related Products: Hub Mini Matter Enabled
...
---
### How to Set up Matter with SwitchBot Hub Mini Matter (Android)

Last Updated: 2024 Jan 25

Related Products: SwitchBot Hub Mini Matter
...
via your SwitchBot Hub Mini Matter to update firmware version automatically. Make sure all devices are on a 2.4Ghz Wi-Fi network.

Note: Unlike the regular Hub Mini, the Matter-enabled  Hub Mini has a Type-C connection terminal.

Getting started using Matter.

When you're ready to get started, select the SwitchBot Hub Mini Matter icon on our app's homepage and enter the your Hub Mini Matter device page. Click the Settings icon in the upper right-hand corner to enter and scroll down to the Matter settings option and click to enter. We can then choose to download our device QR code image or copy its number.

![Image](https://support.switch-bot.com/hc/article_attachments/25998506978967)

Resetting your SwitchBot Hub Mini Matter.

Now, before adding Hub Mini Matter to your Google Home app, you will need to reset Hub Mini Matter.
...
Adding Hub Mini Matter to Google Home.

We recommend copying the number of your device from our app. After copying, click Set up without QR code. A paste button will appear after long pressing, paste the copied number, press continue, and enter the adding process. After entering the adding process, wait a moment and Hub Mini Matter will be added as a gateway, and the temperature and humidity sensor of Hub 2 will also be added to the Home app.
...
settings page of your SwitchBot Hub Mini Matter via our app. You can now associate SwitchBot devices(like Curtain, Blind Tilt, Lock etc...)with SwitchBot Hub Mini Matter and add them as sub-devices. After adding your device, switch to the Google Home app interface, and synchronization will be performed automatically. Sometimes, due to the network environment conditions, synchronization may take some time.
...
Due to Google Home being unable to support humidity sensors, humidity readings will currently be unavailable through the Google Home app when using Hub Mini Matter.

Due to HomeKit security requirements, Hub Mini Matter. may not be added successfully to the Home app when using public Wi-Fi. It is recommended to use personal Wi-Fi.
...
You will need a home hub to control your Hub Mini Matter. and its secondary devices via third-party smart home platforms. Remember that the home hub and your Hub Mini Matter. should be under the same Wi-Fi network.

To add your Hub Mini Matter. across different smart home platforms, you can simply use the sharing code or QR code found in the relevant platform you are looking to use.
...
---
### How to Set up Matter with SwitchBot Hub Mini Matter(iOS)
...
![Image](https://support.switch-bot.com/hc/article_attachments/25996908514455)

Resetting your SwitchBot Hub Mini Matter.

Now, before adding Hub Mini Matter to your Apple Home app, you will need to reset Hub Mini Matter.
...
Adding Hub Mini Matter to Apple Home.

Can't find a Matter QR code on the back of Hub Mini Matter?

If you can't find a Matter QR code on the back of your SwitchBot Hub Mini Matter, we recommend copying the number of your device from our app. After copying the number, enter the Home app. Select Add Accessory in the upper right-hand corner, then click
...
Scan the Matter QR code on the back of your Hub Mini Matter.
...
After entering the adding process, wait a moment and your Hub Mini will be added as a gateway, and the temperature and humidity sensor of Hub 2 will also be added to the Home App.
...
settings page of your SwitchBot Hub Mini Matter via our app. You can now associate SwitchBot devices(like Curtain, Blind Tilt, Lock etc...)with SwitchBot Hub Mini Matter and add them as sub-devices. After adding your device, switch to the Home App interface, and synchronization will be performed automatically. Sometimes, due to the network environment conditions, synchronization may take some time.
...
You will need a home hub to control your Hub Mini Matter and its secondary devices via third-party smart home platfroms. Remember that the home hub and your Hub Mini Matter should be under the same Wi-Fi network. For example, in Apple Home, you will need a HomePod or Apple TV as a home hub. HomePod's software version should be 16.5 or above.
...
After the personal hotspot is enabled, follow the steps to proceed your test.
...
![Image](https://support.switch-bot.com/hc/article_attachments/12087070098199)
...
6. The remote control units registered in other Hub Mini/Ceiling Light Pro units will be displayed. Select the remote control to be copied and tap the Copy button.
...
---
### What to Do If I Am Unable to Add SwitchBot Hub Mini Matter Enabled to iOS Home App?
...
---
### Which Devices Are Compatible With Matter via SwitchBot Hub Mini Matter Enabled?
...
4. Use a 5V1A/5V2A charging adapter for the Hub Mini.  
5. Place the Hub Mini closer to the Wi-Fi router (within 5 meters).  
6. Restart your home router.  
7. As a troubleshooting step, check if the Hub Mini can connect to your smartphone's hotspot.  
[https://support.switch-bot.com/hc/en-us/articles/32573508408983](https://support.switch-bot.com/hc/en-us/articles/32573508408983-How-to-Add-SwitchBot-Devices-to-SwitchBot-App-Using-Smartphone-s-Personal-Hotspot)
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
Could you please provide a photo showing the damaged charging cable that was included?
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. The Hub Mini comes in two versions: the standard version and the Matter-compatible version. Please ensure that your Hub Mini is the Matter-compatible version.
2. Please confirm that the firmware version of your Hub Mini Matter is 2.5-3.5 or newer. If not, update it near the device via the SwitchBot app → Hub Mini Matter → Gear Icon → Firmware & Battery.
3. Make sure the Hub Mini Matter, iPhone, and HomePod Mini/Apple TV are connected to the same 2.4Ghz Wi-Fi network.
4. Before adding the Hub Mini Matter to the Apple Home app, long press the button on the device for 15 seconds to reset it.
...
5. When selecting accessories in the Home App: tap on "My Accessory Isn't Shown Here" rather than choosing the nearby Hub.

<img width="437" height="921" alt="image" src="https://github.com/user-attachments/assets/99e5df45-4153-4ec2-922a-070c39c4f81a" />
...
1. Make sure that the home appliance you are using is infrared remote control. If the remote control is a mixture of infrared and Bluetooth, only the infrared button can be used.
2. Please use the latest version of the SwitchBot app from the app store. Issues may occur when using the Beta version. Thank you for your understanding.  
3. Make sure your hub mini matter firmware version is 2.5-3.5 or later if it can connect to your smartphone's hotspot. If not, update it near the device by following this sequence: SwitchBot App → hub mini matter → Gear Icon → Firmware & Battery.
3. Make sure that the hub mini matter is powered by a 5V1A/5V2A adapter.
4. Make sure that you are connected to a stable 2.4GHz network. If the network is disconnected, the lamp on the hub mini matter will blink.
5. Make sure that there are no walls or other obstacles between the hub mini matter and the appliance, as infrared signals do not pass through walls.
6. Since the hub mini matter operates the appliance instead of the remote control attached to the appliance, place the hub mini matter within the infrared reception range of the appliance.
7. Please adjust the installation position of the hub mini matter until the appliance actually responds.
8. There are four ways to learn infrared remotes. If the remote control cannot be registered by "Smart learning" and "Select manually", we recommend that you add it in "learn buttons" or "others" mode.
[https://support.switch-bot.com/hc/en-us/articles/360038240833
](https://support.switch-bot.com/hc/en-us/articles/360038240833-How-to-Add-Infrared-Appliances-to-SwitchBot-Hub-Mini)
