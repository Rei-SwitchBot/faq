...
---
### Troubleshooting When I Turn on the AC with SwitchBot App, the AC Units Displays Celsius Instead of Fahrenheit, and I Have a Hub 3.
...
---
### Troubleshooting Only the Power and Mute Buttons on the TV Remote Can Be Learned with SwitchBot Hub 3, Other Buttons Cannot.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Make sure that the Hub 3 is connected to a power source and powered on.
2. Make sure that the Hub 3 is connected to a stable 2.4GHz (802.11b/g/n, IPv4) network.
3. Make sure there are no obstacles, such as walls, between the Hub 3 and the infrared appliances. 
4. Please check for any available firmware updates by going to SwitchBot app → Hub 3 → Gear icon → Firmware & Battery. If needed, update the firmware to the latest version located near the device.
...
7. As a troubleshooting step in case there is a problem with the Hub 3, if you have other Hub products, please copy the infrared remote to another Hub and check if it can be controlled.
