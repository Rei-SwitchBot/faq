...
---
### About LED Indicator Light on SwitchBot Floor Cleaning Robot S20 Water Station
...
3. The indicator stays lit in white while the S20 is filling up with water at the water station and then goes out after fetching it.
...
---
### At What Battery Level Will SwitchBot Floor Cleaning Robot S20 Trigger Automatically Recharge?
...
When the S20 robot's battery drops to

15%

, it automatically returns to the base station for recharging. Once it reaches an 80% charge, it continues any cleaning tasks that are unfinished.
...
---
### Can I Use SwitchBot Floor Cleaning Robot S20 Connected to Smartphone Tethering without Wi-Fi?
...
You can use the S20 connected to a smartphone's tethering, but please note the following guidelines:
...
2. Prepare two smartphones with hotspot capabilities. Use Phone B to establish your hotspot Wi-Fi. Then, with Phone A, connect to the hotspot provided by Phone B to setup and operate your S20.



---
### Can SwitchBot Floor Cleaning Robot S20 Clean up Standing Water From the Floor?
...
When the S20 is in vacuum mode, it doesn't avoid accumulated water and sucks it directly into the dust box, which might cause fan issue. Also, if water or debris enters the dust box, it needs to be cleaned manually. So please ensure that the floor is dry before starting to vacuum.



---
### Do I Need to  SwitchBot Floor Cleaning Robot S20 Before Using It?
...
It is recommended to  the S20 for 4 hours before using it for the first time to ensure optimal cleaning performance, as the battery may not be fully d at the time of shipment.



---
### Getting Started Using SwitchBot Floor Cleaning Robot S20 (Video)
...
---
### How Long Does the Cleaning Solution Last in SwitchBot Floor Cleaning Robot S20?
...
---
### How to Add the Cleaning Solution to SwitchBot Floor Cleaning Robot S20
...
3. If you need to use the S20 to supply water to the Evaporative Humidifier (Auto-refill) after adding the cleaning solution, please review the precautions
...
---
### How to Check Water Station Battery Level of SwitchBot Floor Cleaning Robot S20
...
2. Make sure SwitchBot Floor Cleaning Robot S20 has been added to your App.

3. Please check the water station battery level in the following order.

Launch SwitchBot App and login.

Tap the relevant SwitchBot Floor Cleaning Robot S20.
...
---
### How to Create Multiple Maps with SwitchBot Floor Cleaning Robot S20
...
Tap the relevant Floor Cleaning Robot S20.
...
---
### How to Install SwitchBot S20 Water Station (Video)
...
---
### How to Mark SwitchBot Evaporative Humidifier (Auto-refill) for SwitchBot Floor Cleaning Robot S20

Last Updated: 2024 Sep 26

Related Product: SwitchBot Floor Cleaning Robot S20, SwitchBot Evaporative Humidifier (Auto-refill)

SwitchBot App Version: 9.1 or newer

1. Make sure your SwitchBot App version is up to date.

2. Make sure SwitchBot Floor Cleaning Robot S20 and SwitchBot Evaporative Humidifier (Auto-refill) have been added to your App.

3. Mark the Evaporative Humidifier (Auto-refill) for the S20 in the following order.

Launch SwitchBot App and log in.

Tap your SwitchBot Floor Cleaning Robot S20.
...
The S20 will automatically move to the Evaporative Humidifier (Auto-refill) and mark it.
...
---
### How to Mark the Tatami Area on the Map of SwitchBot Floor Cleaning Robot S20
...
![Image](https://support.switch-bot.com/hc/article_attachments/25300931918487)



---
### How to Re-pair the Floor Cleaning Robot S20 with the Water Station

1. Make sure that the S20 is powered on by removing the main unit's faceplate and switching the power to I.  If the S20 does not turn on, dock it at the base station and charge for 30 minutes.
2. Manually dock the S20 to the water station and make sure the charging terminals are fully contacted.
...
4. Press the home button on the main unit of the S20 for 6 seconds, and you will hear a voice from the S20 saying, "Entering Bluetooth pairing mode".

![image](https://github.com/user-attachments/assets/2b4fa071-03b3-4ec9-b001-e6961eebddf9)

5. Wait 10 to 20 seconds, then the S20 will announce the success of Bluetooth pairing.
6. If pairing fails, please check the following:
  1. Restart the S20 and try the above steps again.
  2. Clean the charging terminals of the S20 and the water station with tissue paper. 
  3. If pairing is successful, please update the firmware of the water station to the latest version by going to SwitchBot App -> S20 -> Gear Icon -> Firmware & Battery -> Water Station
  4. If pairing or communication failure still occurs, please provide us with the following information so that our R&D team can investigate.
    ...
    2. A video showing the S20 failing to dock at the water station

---
### How to Reset SwitchBot Floor Cleaning Robot S20
...
Long press home button mode switch button and clean button for more than 6 seconds will reset the Floor Cleaning Robot S20.

Once reset, all settings will be restored to factory defaults and the S20 will automatically be removed from your SwitchBot account.



---
### How to Set No-go Zones for SwitchBot Floor Cleaning Robot S20
...
---
### How to Set SwitchBot Floor Cleaning Robot S20 Mop Drying Time?
...
2. Make sure your Floor Cleaning Robot S20 has been add to SwitchBot App.

3. Set up the mop drying time for your S20 in the following order:
...
---
### How to Set Up SwitchBot Floor Cleaning Robot S20 and Mark Water Station Position
...
2. Plug the power cable of SwitchBot Floor Cleaning Robot S20's base station.
...
Related Product: SwitchBot Floor Cleaning Robot S20
...
---
### How to Set up the Dust Collection Frequency for SwitchBot Floor Cleaning Robot S20
...
3. Set up the Dust Collection Frequency for your S20 in the following order:
...
---
### How to Turn off the LED Light on the Side of SwitchBot Floor Cleaning Robot S20

Last Updated: 2024 Sep 06

Related Product: SwitchBot Floor Cleaning Robot S20

SwitchBot App Version: 9.0 or newer

When the S20 enters darker areas, such as under beds or in dimly lit rooms, its side LEDs will automatically turn on. This feature helps the robot map and clean more effectively in low-light environments.

If you find that you don't need this feature, you can easily turn it off by going to SwitchBot App -> S20 -> Gear icon -> More Features -> disable AI Obstacle Avoidance

![Image](https://support.switch-bot.com/hc/article_attachments/26178078350487)

Note:

SwitchBot Floor Cleaning Robot S20 does not have a built-in microphone, so you don't need to worry about privacy concerns such as recording sounds in your home.



---
### How to Use Your SwitchBot Floor Cleaning Robot S20 (Video)
...
---
### Ingredients in the SwitchBot Floor Cleaning Robot S20 Cleaning Solution
...
---
### Installation and Maintenance of SwitchBot Floor Cleaning Robot S20 External Water Tank Assembly (Video)
...
---
### Instruction of SwitchBot Floor Cleaning Robot S20's "Room" Feature
...
---
### Introduction of SwitchBot Floor Cleaning Robot S20 External Water Tank Assembly
...
1. If it's not possible to install a water station for the S20 in your house, we suggest using an external water tank.

2. The external water tank consists of a waste water tank and a clean water tank. The S20 is capable of mopping as long as the clean water tank is regularly refilled and the waste water tank is emptied.

3. For installation and maintenance of the external water tank, please refer to the following video.

[Embedded Content](//www.youtube-nocookie.com/embed/o5413fr7R2U)

4. An external water tank is available for customers purchasing the S20 through Kickstarter.
...
---
### Is the Cleaning Solution for SwitchBot Floor Cleaning Robot S20 Pet Friendly?

Last Updated: 2024 Sep 05

Related Product: SwitchBot Floor Cleaning Robot S20

The main ingredients of the Floor Cleaning Robot S20's cleaning fluid are deionized water and surfactants. It also contains a citrus fragrance (with a concentration lower than 0.0025% after dilution), which emits a mild, pleasant scent when used. These components are effective in cleaning and are harmless, containing no essential oils, and therefore will not cause any harm to pets. Thus, you can use our product with confidence.

As an additional suggestion, we recommend that you only use the cleaning solution specified by SwitchBot official. It is not advisable to add any essential oils (such as pine oil) to the water, as this may damage the internal structure of the Floor Cleaning Robot S20, and many essential oils could be hazardous to your pet's respiratory and digestive systems.



---
### Is the LiDAR SLAM Laser Equipped on SwitchBot Floor Cleaning Robot S20 Harmful to Humans?
...
The LiDAR SLAM laser equipped on the S20 is safe for humans, so you can use it without any worries.



---
### Power Consumption of Floor Cleaning Robot S20
...
SwitchBot Floor Cleaning Robot S20 primarily consumes power during charging and when drying the mop. The mop drying process requires approximately 105W of power, and depending on the duration of the drying task (typically 3 to 4 hours), the energy consumption is around 0.315 to 0.42 kWh.

When it comes to charging, the S20 operates at about 29W. A full charge takes roughly 3 hours, during which it consumes approximately 0.08 to 0.09 kWh.
...
---
### Reasons About SwitchBot Floor Cleaning Robot S20 Not Supporting 5GHz Wi-Fi Networks
...
---
### SwitchBot Floor Cleaning Robot S20 Auto empty Station Maintenance (Video)
...
---
### SwitchBot Floor Cleaning Robot S20 Maintenance (Video)
...
---
### SwitchBot Floor Cleaning Robot S20 Water Station Maintenance (Video)
...
---
### Use Schedule Feature to Clean a Specific Room with SwitchBot Floor Cleaning Robot S20
...
---
### Voice Commands to Control SwitchBot Floor Cleaning Robot S20 with Alexa
...
, you can control your SwitchBot Floor Cleaning Robot S20+ vocally through Alexa. The Alexa Customer Skill for the SwitchBot Floor Cleaning Robot S20+ is a feature that offers specialized voice commands for enhanced voice control via Alexa. While the SwitchBot Floor Cleaning Robot S20+ initially offers only the default on/off command with Alexa, the Customer skill broadens this scope, enabling voice control for commands such as "pause", "resume cleaning", and "return to charging station".

Prepare Before Use

SwitchBot Floor Cleaning Robot S20+ is already registered and connected to the network.
...
When you command Alexa with "Alexa, activate SwitchBot," it enables the Customer Skills mode. To operate each SwitchBot Floor Cleaning Robot S20+, even if you possess multiple units, simply instruct the robot as indicated in the "Example commands for each function" section below when the relevant mode is active.

※Please ensure you say, "Alexa, activate SwitchBot," as the voice command is designed accordingly.

Step 2: Defining "SwitchBot"

You can activate the SwitchBot Floor Cleaning Robot S20+ by saying the instruction command.

※Should you possess multiple SwitchBot Floor Cleaning Robot S20+, each one will be activated.
...
---
### Voice Commands to Control SwitchBot Floor Cleaning Robot S20 with Google Assistant
...
---
### What is the Dust Box Capacity of SwitchBot Floor Cleaning Robot S20?
...
The dust box capacity of the S20 is
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Restart your phone’s Bluetooth and lift the S20’s faceplate to toggle the switch from "o" to "I".

![image](https://github.com/user-attachments/assets/baaa122c-24ed-48c9-8dda-c4d85eeb4fdd)

2. Bring your phone close to your S20 and check if it needs a firmware recovery by navigating to SwitchBot App -> Profile -> Firmware Recovery -> Recovery.
...
2. Make sure your S20 is connected to 2.4GHz Wi-Fi.
...
5. Please try connecting your S20 to your smartphone's tethering. Once you've successfully connected via tethering, please update the firmware to version 1.0.460 and then attempt to connect to your home Wi-Fi again.
1. Make sure your S20 is connected to 2.4GHz Wi-Fi.



---
### What to Do If My Floor Cleaning Robot S20 Can’t Automatically Return to the base station?
...
1. Make sure that the base station is properly connected to a power source.

2. Make sure that the base station has not been moved and that the robot is correctly oriented for returning. If the base station has been moved, you will need to manually move the robot back to it.

3. Make sure there are no obstacles near the base station and that there is a 0.5m space on both sides, as well as 1m in front of and above the station. Also, be mindful that closed doors and other obstructions may disrupt the return path.

4. Make sure that the base station is placed on a hard, level surface, away from heat sources, direct sunlight, or soft surfaces like carpets or rugs.

5. Use a soft cloth to wipe the signal emitter area on the base station to remove any dust or debris that might be interfering with the robot’s ability to return.
...
2. Make sure you are performing the firmware upgrade near the S20 to maintain a stable connection.

3. If the firmware upgrade for the S20 main unit fails, try turning off the main unit and then turning it back on before attempting the upgrade again. The power switch is located under the faceplate.
...
---
### What to Do If My Floor Cleaning Robot S20 Is Charging Slowly?
...
3. Please note that it typically takes about 3-4 hours to fully charge the S20 from a low battery.
...
---
### What to Do If My Floor Cleaning Robot S20 Leaks When Mopping the Floor？
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1．Please deep clean the roller mop before mopping by going to SwitchBot App -> S20 -> Functions in the lower left corner -> Control -> Wash Mop.
2．Adjust the amount of water for mopping as needed by going to SwitchBot App -> S20 -> Cleaning Mode in the lower right corner -> Vac & Mop -> Mopping water level.
3．Please enable "dampen mop" feature by going to SwitchBot App -> S20 -> Functions in the lower left corner -> Settings -> Mop Cleaning.
4．Please check the tires of the S20 for dirt. Also, clean them manually if necessary.
5．Please check if the roller mop of the S20 is touching the ground properly. If not, please follow the link below for troubleshooting.
...
---
### What to Do If My Floor Cleaning Robot S20 Won't Recognize the Water Station?
...
Related Post: How to Re-pair the Floor Cleaning Robot S20 with the Water Station
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Make sure that the base station is placed on a hard, level surface, away from soft surfaces like carpets or foam mat.
2. Make sure the base station is properly plugged into a power source (When the base station is connected to power, the indicator light will remain solid white.). 
3. Try unplugging and then plugging back in the base station.
4. Clean the charging terminals between the S20 main unit and the base station. Then manually dock the robot to the base to check if it improves (When properly docked, the station will blink white three times and then turn off the light).
5. Please update the firmware version of the S20 and base station to the latest version if you have already added them to the SwitchBot app.
...
---
### What to Do If My Floor Smells After Mopping with SwitchBot Floor Cleaning Robot S20?
...
[How to Set up SwitchBot Floor Cleaning Robot S20 Roller Mop Cleaning Frequency](https://support.switch-bot.com/hc/en-us/articles/26152817866391)
...
---
### Will the Battery Be Affected if I Don’t Use SwitchBot Floor Cleaning Robot S20 for an Extended Period?
...
To maintain the lifespan of the built-in lithium battery, it is recommended to recharge the S20 at least every 3 months if it will not be used for an extended period.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Make sure that you have enabled the auto-add solution function by Navigating SwitchBot App -> your S20 -> Functions -> Settings -> Maintenance -> auto-add solution.
...
Please enable "dampen mop" feature by going to SwitchBot App -> S20 -> Functions in the lower left corner -> Settings -> Mop Cleaning.
6. Increase the mop drying time by going to SwitchBot App -> S20 -> Functions -> Settings -> Drying Time.
7. Check if warm air is coming out from the bottom of the base station when drying the mop. When the drying time is up, manually check if the mop is dry.
...
Regarding this issue, could you please check the following points?
1. Remove the robot's faceplate and restart it.
2. Please check if any foreign object is caught in the S20.
...
2. Please check if pushing the radar cover of the S20 with your hand improves it.
...
---
### What to Do If My Floor Cleaning Robot S20 Doesn't Dock at the Water Station Frequently?

Related Product: SwitchBot Floor Cleaning Robot S20
SwitchBot App Version：9.3 or newer
Firmware Version: 1.0.984 or newer
1. Make sure you have marked the water station's position on the created map. If not, please go to SwitchBot App -> your S20 -> Functions -> Settings -> Mark Water Station Position after mapping.
...
5. If you have replaced the S20 main unit or the water station, you will need to manually pair the S20 with the water station via Bluetooth.

Related Post: How to Re-pair the Floor Cleaning Robot S20 with the Water Station：https://support.switch-bot.com/hc/en-us/articles/25122838665111
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Make sure you have already marked the Evaporative Humidifier (Auto-refill) for your S20.
How to Mark SwitchBot Evaporative Humidifier (Auto-refill) for SwitchBot Floor Cleaning Robot S20


2. If the Evaporative Humidifier (Auto-refill) hasn't been filled, please adjust the refilling settings in SwitchBot App by going to your S20 -> Gear Icon -> More Features -> Humidifier Settings and changing from Refill 10 times to Fill up.

3. Please check if the S20 unit is working properly by going to the SwitchBot App -> your S20 -> Functions -> Wash Mop under Control. If the S20 can wash its mop, then there's nothing wrong with the robot.
...
- Turn on the S20 to refill water to the humidifier, and after a successful connection, check for air bubbles in the mouth of the water tube.
- If there are no air bubbles, move the S20 away from the humidifier manually, remove the auto-fill port of the humidifier, wait for automatic re-docking by S20, and check for any air bubbles in the mouth of the tube.
...
3. Make sure that the dust bag in the base station is not full. The dust bag should be replaced approximately every 2–3 months.
4. Check the debris evacuation port and tube of the base station for debris. If blockages are found, carefully clean them to restore proper function.
5. Check if the indicator light on the base station is orange, which may indicate an issue.
6. Make sure the input voltage listed at the bottom of the base station matches your household voltage.
7. Open the lid of the base station and inspect the interior for any signs of moisture.
8. If the dust is not being collected properly, please open the lid of the base station and check if there is an attached dustbag or similar item inside. If present, remove it and try emptying the dustbin again.


---
### Troubleshooting SwitchBot Floor Cleaning Robot S20 Is Charging Slowly
...
4. The S20 automatically cleans its roller mop while mopping. However, when operating on uneven surfaces or areas with height differences, some dirt from the roller mop may be left on floor joints or gaps. To address this issue, please consider the following solutions:
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
Please check the following points regarding the battery consumption of your Floor Cleaning Robot S20:
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Can you please provide a video showing the beeping noise the S20 is making while charging? This will help us determine if the robot needs to be repaired or replaced.
2. Also, if the replacement or repair service is needed, to expedite shipment, please provide us with the necessary details so we can assist you as soon as possible.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Turn the S20 over, tap the robot's tail with a tool, and then try to remove the waste water box while the robot is still upside down.

![image](https://github.com/user-attachments/assets/a9611f67-2198-4042-a713-72b5d462ca7a)


---
### It Possible to Pair Multiple Water Stations for One Floor Cleaning Robot S20?

With firmware version 1.0.946, one S20 can now be paired with multiple water and base stations. You can manually take the S20 to different floors for cleaning purposes. Water stations are not currently available but can be arranged through after-sales service. Please feel free to contact us.
Note: The S20 can store a maximum of 5 maps, each with one water station configuration. As a result, you can currently place up to 5 water stations.
...
With firmware version 1.0.984 or later, the S20 works directly with Matter as a standalone device. This means you can add it straight to your Apple Home app to control mapping, start cleaning, and check standby status. Currently, room-specific cleaning isn't available as the S20 supports Matter 1.2 features, and we're working on adding Matter 1.4 support in future updates.
The Google Home app now supports the "robot vacuum cleaner" device type. Connect your Google Home hub and the S20 robot to the same 2.4 GHz network , then add it to the Google Home app using Matter. Also, since the S20 is compatible with Matter V1.2 specifications, some features may not be available yet. Thank you for your understanding.


---
### Voice Commands for Controlling SwitchBot Floor Cleaning Robot S20 Using Google Assistant
...
---
### Voice Commands for Controlling SwitchBot Floor Cleaning Robot S20 Using Alexa

Using the Alexa Customer Skill, you can control your SwitchBot Floor Cleaning Robot S20+ vocally through Alexa. The Alexa Customer Skill for the SwitchBot Floor Cleaning Robot S20+ is a feature that offers specialized voice commands for enhanced voice control via Alexa. While the SwitchBot Floor Cleaning Robot S20+ initially offers only the default on/off command with Alexa, the Customer skill broadens this scope, enabling voice control for commands such as "pause", "resume cleaning", and "return to charging station".
Prepare Before Use
- The SwitchBot Floor Cleaning Robot S20+ is already registered and connected to the network.
- The device is already linked to Alexa.
Below, you will find the instructions for using the Customer Skill.
Step 1: Engaging Customer Skills Mode and Providing Instructions
When you command Alexa with "Alexa, activate SwitchBot," it enables the Customer Skills mode. To operate each SwitchBot Floor Cleaning Robot S20+, even if you possess multiple units, simply instruct the robot as indicated in the "Example commands for each function" section below when the relevant mode is active.
※Please ensure you say, "Alexa, activate SwitchBot," as the voice command is designed accordingly.
Step 2: Defining "SwitchBot"
You can activate the SwitchBot Floor Cleaning Robot S20+ directly by saying "SwitchBot" followed by the instruction command, without the need to invoke the customer skills mode.
※Should you possess multiple SwitchBot Floor Cleaning Robot S20+, each one will be activated.
Examples of Commands for Each Function
...
---
### Is It Possible to Control SwitchBot Floor Cleaning Robot S20 with Smartthings?

We're excited to let you know that starting on 29/08/2024, you'll be able to control your S20 using the SmartThings App. If you can't find your S20 in the SmartThings App, try unlinking it from SwitchBot and then linking it again.

---
### Local Functions of SwitchBot Floor Cleaning Robot S20 via Home Assistant Without Cloud?

When operating the S20 locally through the Home Assistant app, the following functionalities are available:
...
---
### How Often Should I Replace the Dust Bag of the SwitchBot Floor Cleaning Robot S20?
...
---
### Will I Receive a Push Notification From Switchbot When the Dust Bag of the Switchbot Floor Cleaning Robot S20 Is Full?

We regret to inform you that SwitchBot Floor Cleaning Robot S20 currently does not have a push notification feature in the app to alert you when the dust bag is full. The dust bag has a capacity of 4 liters, and we recommend replacing it every 2 to 3 months, depending on your actual usage and household environment. 

---
### What Should I Check Before Purchasing SwitchBot Floor Cleaning Robot S20?
...
- A photo of the exact location where you plan to install the S20.
- The diameter of your home's drainage and water inlet pipes.
- Your specific concerns.

---
### Time and Trips Needed for SwitchBot Floor Cleaning Robot S20 to Refill SwitchBot Evaporative Humidifier Auto-refill

SwitchBot Floor Cleaning Robot S20’s internal water tank holds about 250 ml, while the Evaporative Humidifier Auto-refill’s tank capacity is approximately 4.5 liters. In testing, if the S20 operates without interruptions or other task interference, it typically requires around 23 trips and approximately 100 minutes to fully refill the humidifier.
The S20 also features an automated refilling option, so you can simply adjust refilling settings to match specific humidity needs and room conditions.
Way to setup: SwitchBot App -> your S20 -> gear icon -> More Features -> Humidifier Settings
Note: The built-in water tank of the S20 is approximately 250 ml, but the actual water supply to the humidifier is designed to be approximately 180 ml per water supply.

---
### How to Edit the Wi-Fi Settings of SwitchBot Floor Cleaning Robot S20

1. Make sure your SwitchBot App version is up to date.

2. Make sure SwitchBot Floor Cleaning Robot S20 has been added to your App.

3. If your S20 is online, please edit the wi-fi settings next to the S20 in the following order.
- Launch SwitchBot App and login
- Tap your SwitchBot Floor Cleaning Robot S20
- Tap the gear icon in the upper right corner
- Tap "Wi-Fi Settings"
...
4. If your S20 device is offline on the SwitchBot App, you can delete it from the App by long-pressing and then re-add it to reconnect to Wi-Fi.
If you remove and re-add the S20 to your account, any maps you've created will still be cleared. This means you'll need to remap when adding or removing the device from your account. We sincerely apologize for any inconvenience this may cause.

---
### Is It Possible to Copy the Map Created by SwitchBot Floor Cleaning Robot S20?

We regret to inform you that copying the created map by S20 is not currently supported. 

---
### Why Does SwitchBot Floor Cleaning Robot S20 Make a Sound Every Ten Minutes While Drying the Roller Mop?

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
The Floor Cleaning Robot S20 emits a sound every ten minutes while drying the mop. This is because the robot rotates the mop at regular intervals to achieve optimal drying. Please note that this is an intentional design feature and not a malfunction. You can safely continue using the product without any concerns.
If you have any other questions, please feel free to contact us.

---
### About the Temperature of SwitchBot Floor Cleaning Robot S20 When Drying Mop

When the S20 dries its mop, the core air outlet temperature is around 50°C (122°F), which is lower than the heat from a heated carpet or a hot air blower. This temperature is set within a safe range and is designed to prevent any damage to your flooring during normal use.
...
---
### Installation Notes for SwitchBot Floor Cleaning Robot S20 base station and Water Station

When installing the water station and base station for the S20, it is recommended to maintain a distance of at least 1 meter between them. Failure to do so may result in signal interference leading to cleaning leaks.
...
---
### How Should I Set Up SwitchBot Floor Cleaning Robot S20 and Evaporative Humidifier (Auto-Refill) for Automatic Water Refilling?
...
4. Keep at least 1 meter of distance between the humidifier and the S20’s Water Station and base station. Avoid placing them directly facing each other, as infrared signal interference may cause docking issues or missed cleaning sessions.
...
---
### Placement Guidelines for SwitchBot Floor Cleaning Robot S20 Water Station
...
5. Moving the Water Station during everyday use may prevent the Floor Cleaning Robot S20 from changing water properly. If the placement conditions restrict the back of the Water Station from having a support point, you can use the water pipe holder from the S20 Water Pipe Kit, or other tools, to secure the Water Station in place and prevent it from being easily moved.
...
The acceptable temperature range for the water in the water system of the S20 is between 0°C and 40°C (32°F~104°F). However, we recommend using water within the temperature range of 5°C to 40°C (41°F~104°F).


---
### Can I Use Cleaning Solutions From Other Brands for SwitchBot Floor Cleaning Robot S20?

No. Non-SwitchBot cleaning solutions should not be used as they may cause corrosion to the S20's water station. If needed, please buy the official SwitchBot cleaning solution from our website.

---
### Can I Use Homemade Cleaning Solutions in the SwitchBot Floor Cleaning Robot S20?

No. Homemade cleaning solutions may cause corrosion to the water station of the S20, so please do not use DIY cleaning solutions. If necessary, we recommend purchasing the official SwitchBot original cleaning solution available on our official website.

---
### Can Hard Water Be Used in SwitchBot Floor Cleaning Robot S20?

SwitchBot Floor Cleaning Robot S20 uses cold water directly from your household water supply and does not heat the water during operation. This means limescale buildup occurs at a slower rate. However, if your local water supply has high hardness, limescale may still form over time with regular use. We recommend checking your water hardness level and considering your usage frequency before deciding whether to use the S20 with hard water.

---
### Is It Possible to Purchase Just the Water Station for the SwitchBot Floor Cleaning Robot S20?

Currently, the water station for the S20 is not available for individual purchase. If there is an issue with the water station during the warranty period, we will arrange a replacement for you. For separate purchases, please contact customer support for assistance.
...
SwitchBot App Version：9.3 or newer
Firmware Version: 1.0.984 or newer
Floor Cleaning Robot S20+the Water Station+the base station one set:

1. Make sure your SwitchBot App version is up to date.

2. Make sure SwitchBot Floor Cleaning Robot S20 has been added to your App and your device firmware version is up to date.

3. Mark Water Station Position on your S20.

Related Post: How to Set Up SwitchBot Floor Cleaning Robot S20 and Mark Water Station Position

https://support.switch-bot.com/hc/en-us/articles/22963487317783

4. Before cleaning different floors, please activate the "Water Station Not Marked (Beta)" feature in the SwitchBot App by going to S20 -> Vac & Mop. Wait for water to be supplied to the robot, then manually move it to the target floor. After completing the Vac & Mop, manually move the robot again to where the base station is located and use the app for trash collection and mop drying.
...
3. Mark each water station on each floor on the S20 by going to SwitchBot App -> S20 -> Functions -> Settings -> Mark Water Station Position.
...
4. Manually move the S20 to the target floor and select the cleaning mode in the SwitchBot app. After finishing vacuuming and mopping, the S20 will automatically go to the marked water station to drain and mop clean. If there is no base station, you must move the robot to where it is located and then use the app for trash collection and mop drying.



---
### Troubleshooting Water Inside the Dustbin & Dust Bag of SwitchBot Floor Cleaning Robot S20, Causing Odor

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
The dust bag in the Floor Cleaning Robot S20 is made of non-woven material with moisture-resistant properties, but if the robot frequently picks up wet waste or high-moisture debris, mold and bacteria may grow inside, leading to unpleasant odors. In such cases, we recommend replacing the dust bag more frequently to prevent odor and bacterial buildup.
Additionally, the S20 does not support a mopping-only mode due to its unique roller design. If there is excessive water on the floor, the robot may struggle to handle it properly. If water enters the suction path, it can cause malfunctions, so we strongly advise against allowing the robot to pick up standing water.
If water has already entered the dustbin, dust bag, or base station, please follow these steps:
- Wash the dustbin and filter with clean water, then allow them to dry completely.
- Replace the dust bag with a new one.
- Wipe down the main brush frame, rubber brush, suction port of the base station, and the mop drying outlet with a dry cloth.
...
---
### Troubleshooting Suction Power Drops After SwitchBot Floor Cleaning Robot S20 Runs at Max Power for Around 10 Minutes

We wanted to let you know that when the S20 operates in MAX mode for more than 10 minutes, it will automatically switch to Power mode.
...
---
### Troubleshooting About Hair Getting Tangled on SwitchBot Floor Cleaning Robot S20’s Main Brush
...
The S20 uses a rubber brush, which is designed to reduce hair tangling compared to traditional bristle brushes. However, when there is a large amount of hair, it may still wrap around the ends of the brush. This is a common occurrence with robot vacuums, we recommend using the small cleaning tool included in the package to remove any hair buildup regularly.
...
2. Please refer to the maintenance video to clean and maintain the base station.
Video: https://youtu.be/oBFspfMKsKA


---
### Can I Set the SwitchBot Floor Cleaning Robot S20 to Mopping Mode?

At the current time, the S20 supports a vacuum& mopping mode and a vacuum mode, but it does not have the capability to be set exclusively to a mopping mode. We apologize for any inconvenience this may cause.


---
### How Much Space from the Edge of the Walls Is Not Going to Be Mopped by SwitchBot Floor Cleaning Robot S20?

The S20 is equipped with side brushes that effectively clean dust and debris from corners. However, when performing mopping mode, it is unable to mop within approximately 7~12cm of the wall's edge. Manual cleaning may be necessary for these areas.
...
---
### Troubleshooting SwitchBot Floor Cleaning Robot S20 Makes Sound While Operating

We sincerely apologize if the sound from your S20 has caused any inconvenience. We completely understand how important a quiet and comfortable home environment is, and we appreciate your feedback.
To ensure that the mop stays clean throughout the mopping process, the S20 is designed to automatically clean the mop while in use. This involves continuously spraying clean water, rotating the roller, and collecting dirty water. As a result, some sound is unavoidable. In particular, during the dirty water collection process, the waste water collection gutter presses against the roller to efficiently remove water, which creates slight resistance. This can cause the motor to run louder at times, but rest assured, this is a normal part of the cleaning process.
We are always working to improve our products based on customer feedback. Your insights are invaluable in helping us refine our technology, and we will continue to seek ways to make the S20 even quieter without compromising its cleaning performance. We truly appreciate your support and understanding!
...
---
### Troubleshooting SwitchBot Floor Cleaning Robot S20 Catches on Rug Tassels or Drags Small Rugs
...
---
### SwitchBot Floor Cleaning Robot S20's Water Hose Is Creased and Broken
...
---
### Troubleshooting Missing Accessories for SwitchBot Floor Cleaning Robot S20

We’re sorry to hear that some accessories were missing from your S20 Robot. We truly appreciate you bringing this to our attention, and we’re here to make things right as quickly as possible.
...
---
### How Long Can SwitchBot Floor Cleaning Robot S20 Operate?

The amount of time a fully charged S20 can operate depends on the setting mode.For specific details, please refer to the following information:
Vac & Mop Mode
Quiet Mode: 155min
...
---
### Can SwitchBot Floor Cleaning Robot S20 Clean Under the Sofa?

Including the height of the laser sensor, the overall height of the S20 robot is approximately 115mm. However, to ensure more stable cleaning performance, please use it to clean under furniture, such as sofas, with a clearance of at least 130mm from the floor.

![image](https://github.com/user-attachments/assets/9f064b20-3e98-4756-ac24-7740aba76077)


---
### How Much Area Can SwitchBot Floor Cleaning Robot S20 Clean?

Fully charged S20 can clean different areas depending on the mode you choose. For specific details, please refer to the following information:
Vac & Mop Mode
Quiet Mode: 220㎡
Standard Mode: 185㎡
Strong Mode: 140㎡
...
---
### How to Adjust Room Cleaning Order with SwitchBot Floor Cleaning Robot S20?
...
---
### Can I Wash SwitchBot Floor Cleaning Robot S20’s Roller Mop in a Washing Machine?

No, we do not recommend washing the S20’s roller mop in a washing machine.
...
---
### How Many SwitchBot Evaporative Humidifiers (Auto-refill) Can Be Paired With SwitchBot Floor Cleaning Robot S20?

Currently, only one SwitchBot Evaporative Humidifier (Auto-refill) can be paired with Floor Cleaning Robot S20.
...
---
### Troubleshooting SwitchBot Floor Cleaning Robot S20 Said It Would Wet the Mop Before Cleaning, but It Skipped That Step and Started Cleaning Instead. I’m Using the Custom Mode.
...
---
### What Is the Virtual Wall Thickness Setting for SwitchBot Floor Cleaning Robot S20?

The Floor Cleaning Robot S20 creates virtual walls with a default thickness of 45 cm in its map settings.

---
### How Long Does the base station of SwitchBot Floor Cleaning Robot S20 Typically Last?

The lifespan of the base station depends mainly on the durability of its internal dust collection fan. With normal use (emptying about 3-4 times per day), the station can typically last around 2 years.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding the issue of not being able to add the S20 to the Home app directly via matter, could you please check the following points?
1. Follow the in-app instructions to add your S20 to the Apple Home app by navigating SwitchBot App -> S20 -> Gear icon (Settings) -> Matter Setup (Beta).

2. Make sure both your  iOS device, S20 and Homepod are connected to the same 2.4GHz Wi-Fi network.

3. Verify your S20 has stable internet connection with no network errors.

---
### Does SwitchBot Floor Cleaning Robot S20's Water Station Automatically Increase Water Pressure for Faster Drainage?
...
To safely use your S20 abroad, you need to buy a model that matches the voltage of your destination or use a voltage transformer with your current unit. Failure to convert the voltage properly could cause the vacuum's base station to short-circuit.
...
2. Please flip the base station and check if the debris evacuation tube is clogged with trash. Unscrew the four screws located at the bottom of the base station and use the provided cleaning tool to clean the tube.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
We understand that you’ve noticed some scratches on the waste water collection gutter of your SwitchBot Floor Cleaning Robot S20. These marks are a result of the manufacturing process and do not affect the functionality of the product.
...
---
### Troubleshooting Purchasing the Diatom Mud Mat of SwitchBot Floor Cleaning Robot S20

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, we regret to inform you that the diatom mud mat for the S20 is not currently sold separately. However, we are happy to provide it at no charge. Since it ships from our Hong Kong warehouse, a shipping fee (which varies by destination) will apply. If you'd like to request the diatom mud mat, please contact us and we'll provide a shipping quote.
