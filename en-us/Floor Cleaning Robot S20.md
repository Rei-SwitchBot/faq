...
---
### Is It Possible to Purchase the Front Wheel for SwitchBot Floor Cleaning Robot S20 Separately?
...
---
### How to Set up Carpet Cleaning for SwitchBot Floor Cleaning Robot S20

1. You can set up carpet cleaning for your S20 in the following order:
- Launch the SwitchBot app and log in.
- Tap your S20.
- Tap the map icon in the center-left of the screen.
- Go to "Edit Floor".
...
<img width="1280" height="541" alt="image" src="https://github.com/user-attachments/assets/b9752b1a-b28b-4500-b1df-18e1cfde804e" />
...
Video: https://drive.google.com/file/d/1YUG8IiiEw-1CXs5zeZ6AvoFmezgIMQ6V/view?usp=drivesdk
...
Tips:
- Turn the S20 unit over. If there is water in the waste water box, remove it to prevent leakage.
...
---
### How to Replace the Check Valve on SwitchBot Floor Cleaning Robot S20
...
Video: https://drive.google.com/file/d/11B2w-FEb7k_qvvPjVTsh3goE_TEnZ4hA/view?usp=drivesdk
...
4. Clean the charging terminals between the S20 main unit and the auto-empty station. Then manually dock the robot to the base to check if it improves (When properly docked, the station will blink white three times and then turn off the light).
5. Please update the firmware version of the S20 and auto-empty station to the latest version if you have already added them to the SwitchBot app.
