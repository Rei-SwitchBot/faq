...
Make sure the sensor opening is free of dust or debris. If needed, gently blow air into the sensor opening to clean it.
Remove the batteries from the CO2 Monitor (or unplug the power adapter if using the charging cable) and wait for about one minute.
Power the CO2 Monitor back on.
Remove the device from your app, reset it, and then re-add it.
In the SwitchBot app, long press the CO2 Monitor (Meter Pro) to remove it.
Press and hold the button at the top of the CO2 Monitor for 15 seconds to reset it.
After resetting, try re-adding the CO2 Monitor to the SwitchBot app.
...
<img width="387" height="212" alt="image" src="https://github.com/user-attachments/assets/dcf4f8fb-0b21-458d-a630-4055659b28ce" />
...
If you would like to switch the temperature display on your SwitchBot Meter Pro (CO2 Monitor) from Celsius to Fahrenheit (or vice versa), simply press the button on the device itself.
...
<img width="1280" height="430" alt="image" src="https://github.com/user-attachments/assets/82bf2a6a-e595-4225-8e8f-8e3864d37c76" />
...
<img width="1280" height="1079" alt="image" src="https://github.com/user-attachments/assets/d58fe424-1b95-4bb4-ada4-c3792cb2053c" />
...
---
### Troubleshooting: The Type-C Charging Cable of the CO2 Monitor Cannot Be Unplugged
