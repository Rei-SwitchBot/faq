...
4. Please check for any available firmware updates by going to SwitchBot app → Lock → Gear icon → Firmware & Battery. If needed, update the firmware to the latest version located near the device.
...
---
### How to Make SwitchBot Lock Lite Emit an Alarm When the Door Is Not Closed or Locked
