...
---
### Can I Use SwitchBot  Hub 2 Without Wi-Fi?
...
Hub2 cannot work properly without being connected to Wi-Fi.
...
[How to master the Matter function of SwitchBot Hub 2](https://support.switch-bot.com/hc/en-us/articles/12623119544087-How-to-Use-Matter-with-SwitchBot-Hub-2)
...
Yes, Hub 2 has the same thermo-humidity sensor as the SwitchBot Thermo-Hygrometer/Thermo-Hygrometer Plus.
...
---
### How Much Network Traffic Is Consumed When Using SwitchBot Hub 2?

Last Updated: 2023 Sep 18

Related Products: SwitchBot Hub 2

SwitchBot Hub 2 uses 159 kB of data traffic per hour.
...
---
### How to Set up Matter with SwitchBot Hub 2 (Android)
...
via your SwitchBot Hub 2 to update firmware version automatically. Make sure all devices are on a 2.4Ghz Wi-Fi network.
...
Now, before adding Hub 2 to your Google Home app, you will need to reset Hub 2.
...
settings page of your SwitchBot Hub 2 via our app. You can now associate SwitchBot devices(like Curtain, Blind Tilt, Lock etc...)with SwitchBot Hub 2 and add them as sub-devices. After adding your device, switch to the Google Home app interface, and synchronization will be performed automatically. Sometimes, due to the network environment conditions, synchronization may take some time.

![Image](https://support.switch-bot.com/hc/article_attachments/25998506991767)

Please note:

During the Matter beta phase, up to 8 SwitchBot Bluetooth devices can be added to the Google Home App.
...
---
### How to Set up Matter with SwitchBot Hub 2(iOS)
...
Now, before adding Hub 2 to your Apple Home app, you will need to reset Hub 2.
...
Adding Hub 2 to Apple Home.

Can't find a Matter QR code on the back of Hub 2?

If you can't find a Matter QR code on the back of your SwitchBot Hub 2, we recommend copying the number of your device from our app. After copying the number, enter the Home app. Select Add Accessory in the upper right-hand corner, then click
...
Scan the Matter QR code on the back of your Hub 2.
...
After entering the adding process, wait a moment and your Hub 2 will be added as a gateway, and the temperature and humidity sensor of Hub 2 will also be added to the Home App.
...
settings page of your SwitchBot Hub 2 via our app. You can now associate SwitchBot devices(like Curtain, Blind Tilt, Lock etc...)with SwitchBot Hub 2 and add them as sub-devices. After adding your device, switch to the Home App interface, and synchronization will be performed automatically. Sometimes, due to the network environment conditions, synchronization may take some time.
...
You will need a home hub to control your Hub 2 and its secondary devices via third-party smart home platfroms. Remember that the home hub and your Hub 2 should be under the same Wi-Fi network. For example, in Apple Home, you will need a HomePod or Apple TV as a home hub. HomePod's software version should be 16.5 or above.
...
---
### Hub 2 failed to find router, keep connecting network during setup
...
2. Make sure the Hub 2 is connected to a stable 2.4GHz (802.11b/g/n, iPv4) WiFi network instead of a 5GHz one. Currently, the iPv6 network and Wi-Fi 6 router are not supported.

3. In many cases, it helps to fix the router connection by rebooting the router.

4. Please note that building materials and metal objects located between the WiFi router and Hub 2 or between the Hub 2 and your mobile phones impact connectivity. If possible, set up the Hub 2 within a clear line of sight of your WiFi router.

5. If that doesn't work, It is recommended to perform a test by connecting the Hub 2 to a Personal Hotspot from another mobile phone. Pay attention to the following points:
...
6. After the personal hotspot is enabled, follow the steps to proceed your test.

Tap the Hub 2 on SwitchBot App.
...
7. If the Hub 2 is fine connecting to a Personal Hotspot, then the problem may be in the settings of your WiFi router.
...
---
### What Should I Do if Hub 2 Does Not Start Up After Power-On?
...
3. If you have an alternate charging adapter and cable available, try switching to them to see if the device turns on. Once powered on, the Hub 2 will flash its indicator for a while, and Hub 2 will beep and display temperature and humidity data simultaneously.
...
---
### What to Do If I Am Unable to Add SwitchBot Hub 2 to iOS Home App?
...
2. If the Matter scan code is not attached to the back of the Hub 2 unit, please follow these instructions when selecting accessories in the Home App: tap on "My Accessory Isn't Shown Here" rather than choosing the nearby Hub 2, and then proceed to enter the code.
...
---
### Which Devices Are Compatible With Matter via SwitchBot Hub 2?
...
---
### Troubleshooting the Temperature and Humidity of Hub 2 Not Showing Up in Alexa Routines
...
3. Make sure your Hub 2 firmware version is 2.5-3.5 or later if it can connect to your smartphone's hotspot. If not, update it near the device by following this sequence: SwitchBot App → Hub 2 → Gear Icon → Firmware & Battery.
3. Make sure that the Hub 2 is powered by a5V2A adapter.
4. Make sure that you are connected to a stable 2.4GHz network. If the network is disconnected, the lamp on the Hub 2 will blink.
5. Make sure that there are no walls or other obstacles between the Hub 2 and the appliance, as infrared signals do not pass through walls.
6. Since the Hub 2 operates the appliance instead of the remote control attached to the appliance, place the Hub 2 within the infrared reception range of the appliance.
7. Please adjust the installation position of the Hub 2 until the appliance actually responds.
...
2. Check if any schedules have been configured in the SwitchBot App by navigating to SwitchBot App → Hub 2 → Schedule.
...
---
### Troubleshooting: Some Infrared Remote Controls Added Through SwitchBot Hub Are Not Showing in Amazon Alexa.
