...
If necessary, we can also enable "Re-Lock" and set up "Re-lock Timing" ( Re-Lock will lock your door if it has been unlocked after the specified time, no matter your door is open or closed).
...
Regardless of the manufacturer, four commercially available AA batteries (1.5 V) are sufficient.
...
---
### Can I Use My Key to Unlock SwitchBot Lock Pro after It Has Been Installed?

Updated: Mar 24th, 2023

Applicable Products: SwitchBot Lock Pro

Sure, it's possible. This will not affect unlocking the Lock with a physical key. Don't worry.

*Related Posts:

[How to Install the SwitchBot Lock Pro](https://support.switch-bot.com/hc/en-us/articles/4419067614871)
...
Yes, the magnets in Lock and Lock Pro are interchangeable.


---
### Can Someone Else Unlock My Door Lock Via the SwitchBot NFC Tag?

For security reasons, when the SwitchBot Tag has been assigned to lock/unlock a SwitchBot Lock Pro under account A, it can only be triggered by this account. Other accounts cannot do anything with this SwitchBot Tag.
...
cannot be set to dual lock at this time.
...
4. The emergency unlock function is only available within the Bluetooth range of Lock Pro.
...
---
### How to Add SwitchBot Lock Pro with the Apple Home App Using SwitchBot Hub 2 / Hub Mini Matter Enabled
...
Firmware Version: SwitchBot Hub 2 2.0-1.2 or newer, SwitchBot Hub Mini Matter Enabled 2.0-1.2 or newer, SwitchBot Lock Pro 1.8 or newer
...
2． Synchronize your SwitchBot Lock Pro to Home App in the following order:
...
Add SwitchBot Lock Pro

3． Once it is complete, SwitchBot Lock Pro will be displayed within the iOS Home App, enabling voice-activated locking and unlocking via Hey Siri.
...
![Image](https://support.switch-bot.com/hc/article_attachments/23110420021655)
...
---
### Remote Unlock Notifications Feature of SwitchBot Lock Pro
...
---
### Standard for the Screws That Mount SwitchBot Lock Pro JP on the Door

Last Updated: 2024 May 13

Related Products: SwitchBot Lock Pro (JP Version)
...
Only the smartphones of the home owner and admins (must be added to the white list) can trigger the Auto-Unlock function when they move within range of the Lock Pro. At this time, Auto-Unlock is not supported for members or members with limited permissions.
...
---
### SwitchBot Lock Pro Alerts Feature
...
Here is how to turn on App Notifications for your SwitchBot Lock Pro:
...
Here is how to set up Alerts for SwitchBot Lock Pro:

Launch the SwitchBot App and log in.

Tap on the relevant SwitchBot Lock Pro.
...
With the settings in step 4, when the specified time is reached, the SwitchBot Lock Pro device itself will beep three times. When used in conjunction with the SwitchBot Hub series products, you will receive a notification on your smartphone in addition to the beep sound.
...
6. Reinsert the batteries into the Lock Pro.
...
---
### Which Type of NFC Tag is Compatible with SwitchBot Lock Pro?

Last Updated: 2024 May 13

Related Products: SwitchBot Lock Pro

The NFC tag compatible with SwitchBot Lock Pro is

NTAG 216. You can purchase NFC Tags from our official website if needed.
...
Unlike the previous version of the Lock, the lock and unlock positions already recorded on the Lock Pro will not be cleared when the battery is removed and inserted.
...
---
### Where Can I Buy Magnets for SwitchBot Lock Pro?

Thank you for reaching out to us. We sincerely appreciate your support of SwitchBot products.
At the moment, we do not sell SwitchBot Lock Pro magnet separately. However, we understand that this may be an inconvenience, so we would like to offer the following solutions:
...
*The magnet used for both SwitchBot Lock Pro is the same. If you need a replacement magnet for Lock Pro, please follow the same request process as mentioned above. We’d be happy to assist you!
*If you have already provided this information, our team will review it and follow up with you shortly. Thank you for your patience, and please let us know if you need further assistance. *Kindly note that free replacement services may not be available for devices that are no longer under warranty or were purchased through non-official channels.


---
### How to Enable Push Notifications for SwitchBot Lock Pro

1. Make sure your SwitchBot App version is up to date.

2. Make sure SwitchBot Lock Pro and Hub have been added to your App.
...
2. Please check for any available firmware updates by going to SwitchBot app → Lock Pro → Gear icon → Firmware & Battery. If needed, update the firmware to the latest version located near the device. After the firmware update is complete, please recalibrate youre Lock Pro before use.
...
3. Please check for any available firmware updates by going to SwitchBot app → Lock Pro → Gear icon → Firmware & Battery. If needed, update the firmware to the latest version located near the device. After the firmware update is complete, please recalibrate youre Lock Pro before use.
4. Remove Lock Pro from the SwitchBot app, then re-add and calibrate it.


---
### [Request Handling]Lock Pro

Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. One SwitchBot Lock Pro can only be added to one account. If a Lock Pro is added to another account of yours, please delete the Lock Pro from that account first and then add it to a new account.
※SwitchBot App -> Long press the Lock Pro icon -> tap the Delete button -> confirm deletion
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
1. Please check for any available firmware updates by going to SwitchBot app → Lock Pro → Gear icon → Firmware & Battery. If needed, update the firmware to the latest version located near the device. After the firmware update is complete, please recalibrate youre Lock Pro before use.
...
6. Please check for any available firmware updates by going to SwitchBot app → Lock Pro → Gear icon → Firmware & Battery. If needed, update the firmware to the latest version located near the device. After the firmware update is complete, please recalibrate youre Lock Pro before use.
...
Thank you for reaching out to us. We sincerely apologize for any inconvenience this may have caused and appreciate the opportunity to assist you.
Regarding this issue, could you please check the following points?
If your SwitchBot Lock Pro makes a motor sound but stops midway and cannot complete the locking or unlocking action, please follow these steps:
...
---
### Troubleshooting Unable to Add SwitchBot Lock Pro to SwitchBot App Due to "Invalid Ciphertext" Error
...
2. In the same App Notifications menu, scroll to "Notifications Management" under "Device Notifications", find Lock Pro, and make sure notifications are allowed.

<img width="741" height="1280" alt="image" src="https://github.com/user-attachments/assets/41cb41a1-cc79-43e7-8b09-c25d4405f021" />
...
4. Make sure that you are using the latest* firmware version of your Lock Pro. If not, please update the firmware near your device by going to SwitchBot App -> Lock Pro -> Gear Icon -> Firmware & Battery.

 
5. After updating, recalibrate your Lock Pro.
*SwitchBot app -> Lock Pro -> gear icon in the upper right corner ->recalibrate
 
6. Delete the Lock Pro from your app and then re-add it.
  1. Long press your Lock Pro icon on the app to delete it.
  2. Remove the batteries and then reinsert them.
...
---
### How to Make SwitchBot Lock Pro Emit an Alarm When the Door Is Not Closed or Locked
...
4． Set up Alarms for SwitchBot Lock Pro:
- Launch SwitchBot App and log in.
- Tap the SwitchBot Lock Pro.
- Tap the gear icon at the top right.
...
---
### Is It Possible to Install SwitchBot Lock Pro on an Entrance Door That Has a Thumb Turn on the Inside and No Keyhole on the Outside?
