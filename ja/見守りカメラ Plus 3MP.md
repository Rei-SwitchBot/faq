...
---
### 見守りカメラPlus 3MPを三台以上、10台以下を持っている場合、どのクラウドストレージプランを購入すればいいでしょうか。

見守りカメラPlus 3MPを三台以上、10台以下を持っている場合、「カメラ10台まで対応可能」のプランをご購入いただくようお願いいたします。1台、2台、3台対応可能のプランを組み合わせて購入することができかねます。
...
<img width="553" height="549" alt="image" src="https://github.com/user-attachments/assets/fda3242e-cea2-428e-9cf0-6e732cbd212d" />
...
<img width="1127" height="2218" alt="image" src="https://github.com/user-attachments/assets/0f4dfe4f-586a-4697-beb3-8137b43ce35e" />
...
---
### トラブルシューティング見守りカメラ Plus 3MPが赤ランプ点灯していいて、リセットボタンを押しても音がしない。

お問い合わせいただき、ありがとうございます。\n弊社の製品で大変ご迷惑をおかけしております。\n本件について、以下をご確認いただけますでしょうか。\n1．お手元にほかの5V2A充電アダプターとType Cケープルがありましたら、それに切り替えて改善されるかご確認ください。他の充電器で給電した後に、一分間ほどお待ち頂きます。その後ランプが点滅に変わるかをご確認お願い致します。予備充電器がない場合、製品のアタブターをご使用頂きお客様のスマートフォンが充電できるかご確認お願い致します。\n2．リセットピンを使って、見守りカメラ Plus 3MP背部にあるリセット穴を5秒長押ししてリセットをお願いいたします。

---
### トラブルシューティング見守りカメラPlus 3MPは勝手に電源が切れてしまい、SwitchBotアプリ側でオフライン表示になります。
...
---
### 見守りカメラ Plus 3MP用のクラウドストレージファミリープランを、同一アカウント内であれば異なるホームに属するカメラへまとめて適用できますか
...
---
### トラブルシューティング10台以上の見守りカメラPlus 3MPに対応するAIガードプランについて
...
- 右上の歯車マークをタップします。
- 詳細設定をタップします。
- AIガードプランの広告をタップして、オフにするを選択します。

---
### 見守りカメラPlus 3MPは音声を検知して通知を送信できますか？

Last Updated: 2026 Jul 31

- **適用製品：見守りカメラPlus 3MP**

現在、本製品は音声を検知して通知を送信する機能に対応していません。
