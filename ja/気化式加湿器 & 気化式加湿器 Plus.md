...
弊社の製品でご迷惑をおかけしております。
気化式加湿器ファン部分は取り外し不可との構造となりまして、お手入れはできかねます。恐れ入りますが、気化式加湿器のファン/プロペラ部分にカビが生えていると確認できる写真をお願いできますでしょうか。サポートチームにてデバイスの交換が必要か判断させていただきます。また、より早めに手配するために、以下の情報をご提供いただけますでしょうか。
- ご注文番号
- ご購入履歴のスクリーンショット
- 送り先情報
1. お名前
