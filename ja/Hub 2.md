...
本件について、以下をご確認いただけますでしょうか。
1．ご自宅のコンセントが通電していることをご確認ください。
2．充電ケーブルをデバイス本体にしっかりと差し込んでください。しっかり差し込まないと、温湿度データが表示されません。

<img width="716" height="1075" alt="image" src="https://github.com/user-attachments/assets/48486658-5b85-4b7a-8c7b-f190755864eb" />
...
2．SwitchBotアプリ→ハブ2→歯車マーク→Matter設定→サブデバイス→「ラボ機能 (beta版)」の下で、赤外線リモコンの追加ができるかご確認ください。
...
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1. ハブ2が電源に接続され、通電していることをご確認ください。
2. ハブ2は安定した2.4GHz（802.11b/g/n、IPv4）ネットワークに接続されていることをご確認ください。
3. ハブ2は赤外線家電の間に壁などの障害物がないようお願いいたします。
4. SwitchBotアプリ→ハブ2→歯車マーク→ファームウェア&バッテリーの順番で、更新可能なファームウェアバージョンがあるかご確認ください。必要であれば、デバイスの近くでファームウェアを最新バージョンにアップデートしてください。
5. ほかの赤外線リモコンが登録されている場合は、正常に作動するかどうかご確認ください。
6. 該当赤外線リモコンを再度登録してみるようお願いいたします。
7. ハブ2に不具合があるかとトラブルシューティングとして、ほかのハブ製品をお持ちの場合、赤外線リモコンをほかのハブにコピーして、制御できるかご確認ください。
...
下記の順番で登録済みの赤外線リモコンをAppleホームアプリに同期してください。
...
https://support.switch-bot.com/hc/ja/articles/13330959142807
...
---
### トラブルシューティング ハブ2に電源ケーブルを差し込んでも起動しても、オンオフボタンのみ点灯して、温湿度が表示されません。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1. 温湿度センサー電源ケーブルの不具合かどうかを確認するため、ケーブルを使ってハブ2が通電していることがわかる写真または動画をご提供いただけますようお願いいたします。

※動画の提出方法：https://support.switch-bot.com/hc/ja/articles/26996604178967
※すでに提供済みの場合、後ほど担当者より連絡させていただきますので、そのまま少々お待ちいただくようお願いいたします。

---
### Hub 2のON/OFFボタンを押すことで、ロック製品の施錠・解錠が可能ですか。

セキュリティ対策として、ロック製品の施錠・解錠をアクションとしてSwitchBotシーンやオートメーションに設定することはできません。ハブ2のON/OFFボタンはSwitchBotシーンを操作しますが、シーンアクションに設定できないロック製品の操作はできません。ご不便をおかけして申し訳ございませんが、社内で検討させていただき、今後の製品改善とさせていただきます。
備考：ロック製品をハブ3の操作可能なデバイスに追加すれば、ハブ3本体のボタンにてロック製品のコントロールが可能です。買い替えをお考えの場合は、ハブ3のご購入をご検討お願いいたします。
...
---
### ハブ2からよくビープ音が鳴る場合、どうしたらいいでしょうか。 -

Last Updated: 2026 Aug 19

- **適用製品：ハブ2**

1．ブザー警報を完全にオフにしたい場合は、以下の設定をご確認ください。

**SwitchBotアプリ > ハブ2 > 右上の歯車アイコン > 警報設定** に進み、警報機能がオフになっているか確認してください。警報機能がオンになっている場合は、警報方法が **音とライト点滅モード** に設定されていないことをご確認ください。

2．ハブ2が接続しているネットワークが安定していることをご確認ください。ハブ2は、オフラインになったりオンラインに復帰したりする際にビープ音が鳴る場合があります。

3．ハブ2の電源ケーブル、電源アダプター、電源コンセントの状態を確認し、頻繁な電源断・再通電によってビープ音が発生していないかご確認ください。

ハブ2で **音とライト点滅モード** の警報を有効にしておらず、電源ケーブル、電源アダプター、電源コンセントにも問題がない場合は、以下をお試しください。

1．SwitchBotアプリでハブ2を長押しして削除します。

2．ハブ2の電源ケーブルと電源アダプターを抜き、再度差し込みます。

3．ハブ2本体の **On** と **Off** ボタンを15秒間長押しして、ハブ2をリセットします。

4．ハブ2を再度SwitchBotアプリに追加します。

備考：ハブ2を削除またはリセットしても、既存の手動シーンやオートメーションには影響せず、以前に学習したリモコンも削除されません。

---
### ハブ2を追加する際に、Matterアイコン付きの「スキャンして接続」が表示されるのはなぜですか？ -

Last Updated: 2026 Aug 19

- **適用製品：ハブ2**

これはSwitchBot側の問題ではありません。一部のAndroidスマートフォンでは、周囲にMatter規格に対応したデバイスを検出すると、Matter機能を有効にするための**スキャンして接続**という案内が自動的に表示される場合があります。

画面左下の**後で**をタップし、その後表示される画面で**通知をオフにする**に類似したボタンをタップすると、この案内を非表示にできます。
