...
---
### 同じ画面の中で複数のSwitchBot見守りカメラPlus 5MPが撮影した映像を確認できますか？
...
---
### 見守りカメラPlus 5MPはオフラインになってしまいました、どうしたらいいですか。
...
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1. SwitchBotアプリ→見守りカメラ Plus 5MP→歯車マーク→ローカルストレージの順番で録画をオンにしてください。

2. マイクロSDカードをSDカードリーダーに挿入し、パスコンでマイクロSDカードを認識できるかご確認ください。パソコンでも認識できない場合、該当マイクロSDカードの不具合と考えられます。

2. パスコンでマイクロSDカードをFAT32形式にフォーマットしてから、見守りカメラ Plus 5MPに挿入して、改善されるかご確認ください。

3. 複数のマイクロSDカードを持っている場合、他のマイクロSDカードを見守りカメラ Plus 5MPに挿入して、認識できるかご確認ください。他のマイクロSDカードは問題なく認識できる場合、該当マイクロSDカードの不具合と考えられます。
...
---
### トラブルシューティング見守りカメラ Plus 5MPのWi-Fi接続ができてセットアップ画面ではクラウド契約を契約しないと先に進めない

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1．スマートテレビドアホンを含め、カメラ製品は追加が完了されましたら、クラウドストレージのサブスクリプションのご案内が出てきます。必要でない場合は「後でする」をタップして、そのままカメラを使用してください。

<img width="1127" height="2218" alt="image" src="https://github.com/user-attachments/assets/aa2eeec7-700d-4ec5-a105-0f59da8431bd" />


---
### 購入済みのクラウドストレージの注文番号の確認方法

見守りカメラ Plus 5MP、もしくは、見守りカメラ Plus 3MPをご利用の場合、クラウドストレージをご購入いただくと、アプリストアに登録されているメールアドレスに注文情報メールが届きます。メール内で注文番号をご確認いただけます。


---
### トラブルシューティング見守りカメラ Plus 5MPが赤ランプ点灯していいて、リセットボタンを押しても音がしない。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1．お手元にほかの5V2A充電アダプターとType Cケープルがありましたら、それに切り替えて改善されるかご確認ください。他の充電器で給電した後に、一分間ほどお待ち頂きます。その後ランプが点滅に変わるかをご確認お願い致します。予備充電器がない場合、製品のアタブターをご使用頂きお客様のスマートフォンが充電できるかご確認お願い致します。
2．リセットピンを使って、見守りカメラ Plus 5MP背部にあるリセット穴を5秒長押ししてリセットをお願いいたします。

---
### トラブルシューティング見守りカメラPlus 5MPは勝手に電源が切れてしまい、SwitchBotアプリ側でオフライン表示になります。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
より安定した動作を維持するため、カメラは毎週木曜日の午前3時～4時の間に自動的に再起動を行います。再起動にかかる時間は約35秒～80秒で、この間、カメラから「ブーン」という音とわずかな振動（携帯電話の振動に似ている）が発生する場合があります。これによる一時的なオフライン状態は製品の正常な動作であり、不具合ではございません。ご理解の程よろしくお願いいたします。
接触不良によるオフラインかどうかを確認するため、ほかの5V2A電源アダプターとType-Cケーブルに交換し、しばらく様子を見てください。

---
### 見守りカメラ Plus 5MP用のクラウドストレージファミリープランを、同一アカウント内であれば異なるホームに属するカメラへまとめて適用できますか

複数台の見守りカメラ Plus 3MPや見守りカメラ Plus 5MPを利用している場合、プレミアムやファミリーなどの複数台カメラに適用されるクラウドストレージプランを契約し、同一のSwitchBotアカウント内の異なるホームに所属するカメラに割り当てて使用することができます。

一方、従来型のカメラについては、同一アカウント内でも、同じホームに所属するカメラにのみ適用されます。ご了承くださいますようお願いします。
...
---
### トラブルシューティング10台以上の見守りカメラPlus 5MPに対応するAIガードプランについて

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
10台以上のデバイスに対応するAIガードプランをサブスクリプションご希望の場合、後ほど担当部署より改めて連絡させていただきます。念のため、対象機種を確認いたしますが、以下のどのデバイスでしょうか。
- 見守りカメラPlus 5MP
- 見守りカメラPlus 3MP
- スマートテレビドアホン
...
---
### 違う機種の見守りカメラにクラウドストレージ契約する時、一台ずつそれぞれ別々に契約する必要がありますか？

複数のカメラを持っている場合、機種が違っても、同じホームであれば、台数に合わせて(二台分、もしくは、三台分)、クラウドストレージを契約すれば結構で、別々に契約する必要がありません。
クラウドストレージプランは同じホーム内のカメラの間でのみ移行が可能ですが、ホームを渡っての移行はできかねます。複数のカメラが別々のホームに登録されている場合、ホームに応じて、それぞれ個別に契約する必要があります。ご了承お願いいたします。
備考：
SwitchBotアプリのV9.27 より、従来の「クラウドストレージサービス」は 「AIガードプラン」 へと名称・機能を拡充し、リニューアルいたしました。詳細について下記のリンクをご確認ください
https://support.switch-bot.com/hc/ja/articles/40871974522135

---
### トラブルシューティング SwitchBotアプリアップデート後、クラウドストレージのメニューがなくなり、代わりにAIガードプランというメニューになりました。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
SwitchBotアプリのV9.27 より、従来の「クラウドストレージサービス」は 「AIガードプラン」 へと名称・機能を拡充し、リニューアルいたしました。この変更に伴い、以下の製品が対象となります。
- 見守りカメラ Plus 3MP
- 見守りカメラ Plus 5MP
- スマートテレビドアホン
すでにクラウドストレージをご契約中のお客様につきましては、自動的に「AIガードプラン」のベーシックプランへ移行されており、これまで通り引き続きご利用いただけます。ただし、AIまとめなどの新機能をお試しいただくには、ベーシックプランからプレミアムプランへのアップグレードが必要です。
以下に、アップグレードに関する注意事項をご案内いたします。ご自身のご利用状況に合わせて、アップグレードをご検討いただけますと幸いです。
1. ベーシックプランからプレミアムプランへアップグレードされた場合、ベーシックプランの残り期間は無効となり、返金はできかねます。あらかじめご了承くださいませ。
2. アップグレードは即時反映されます。
3. ベーシックプランの期間満了後、プレミアムプランに切り替えることも可能です。
ほかにご不明な点がございましたら、どうぞお気軽にお問い合わせください。
