...
---
### トラブルシューティング見守りカメラのクラウドストレージを申し込もうとしたところ、在庫がないと表示され、購入できません。
...
---
### トラブルシューティング見守りカメラ3MPのクラウドストレージを申し込もうとしたところ、在庫がないと表示され、購入できません。
...
---
### トラブルシューティングSwitchBotアプリで表示された見守りカメラ Plus 5MPのIPアドレスは自宅のルーターのIPアドレスではない

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
見守りカメラ Plus 5MPのWi-Fi設定ページに表示されるIPアドレスは、ご利用のブロードバンド回線のインターネット接続用IPアドレスで、「公衆IPアドレス」や「グローバルIPアドレス」と呼ばれており、ご自宅のルーターのローカルネットワークIPではありません。そのため、自宅のルーターのIPアドレスと異なるIPアドレスが表示されております。ご理解いただけますと幸いです。
ほかにご不明な点などがございましたら、お気軽にお問い合わせください。
...
見守りカメラPlus 5MPを三台以上、10台以下を持っている場合、「カメラ10台まで対応可能」のプランをご購入いただくようお願いいたします。1台、2台、3台対応可能のプランを組み合わせて購入することができかねます。


---
### トラブルシューティングSwitchBotアプリで表示された見守りカメラのIPアドレスは自宅のルーターのIPアドレスではない

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
見守りカメラのWi-Fi設定ページに表示されるIPアドレスは、ご利用のブロードバンド回線のインターネット接続用IPアドレスで、「公衆IPアドレス」や「グローバルIPアドレス」と呼ばれており、ご自宅のルーターのローカルネットワークIPではありません。そのため、自宅のルーターのIPアドレスと異なるIPアドレスが表示されております。ご理解いただけますと幸いです。
ほかにご不明な点などがございましたら、お気軽にお問い合わせください。


---
### トラブルシューティングSwitchBotアプリで表示された見守りカメラ3MPのIPアドレスは自宅のルーターのIPアドレスではない

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
見守りカメラ3MPのWi-Fi設定ページに表示されるIPアドレスは、ご利用のブロードバンド回線のインターネット接続用IPアドレスで、「公衆IPアドレス」や「グローバルIPアドレス」と呼ばれており、ご自宅のルーターのローカルネットワークIPではありません。そのため、自宅のルーターのIPアドレスと異なるIPアドレスが表示されております。ご理解いただけますと幸いです。
ほかにご不明な点などがございましたら、お気軽にお問い合わせください。
