...
---
### Alexa及びGoogle Assistantにて見守りカメラ3MPを操作する音声コマンド例
...
---
### 見守りカメラ3MPとAmazon Alexa(アマゾンアレクサ)のリンク方法
...
2．見守りカメラ3MPはSwitchBotアプリに追加されたことをご確認ください。
...
---
### 見守りカメラ3MPとGoogle Home(グーグルホーム)のリンク方法
...
---
### 見守りカメラ3MPナイトモードの赤外線ライトの波長はどのぐらいですか
...
---
### SwitchBot サードパーティーサービス利用規約

SwitchBot サードパーティーサービス利用規約

2023年5月5日改定

SwitchBot サードパーティーサービス利用規約（以下「本規約」をいう）は、SwitchBot製品/サービスの提供側（SWITCHBOT株式会社、Wonderlabs Inc.、および関連する親会社、子会社、関連会社を含む、以下「SwitchBot」または「当社」をいう）とサードパーティーサービスの利用にあたり本規約を遵守する側（個人、団体を含むが、この限りではない、以下「ユーザー」という）がサードパーティーサービスおよび関連サービスを利用するにあたり必要な条件を定めることを目的とします。本規約はSwitchBotが提供するすべてのサードパーティーサービス（以下「本サービス」をいう）に適用され、規約を締結する期間内のサービスとソフトウェアの更新も含め、サードパーティーサービスを利用することは本規約に同意するものとします。
...
3.2.3 ユーザーは、違法な目的で本サービスを使用しません。いかなる形式であってもSwitchBotサードパーティーサービスを利用して当社の商業利益を侵害しません（当社の許可なく商業告知を配布する行為を含むが、この限りではない）。サードパーティーサービスを使用して、インターネットまたはモバイルの運行に悪影響を与える行為をしません。
...
3.2.5ユーザーがサードパーティーサービスを使用してアップロード、公開、送信、ほかの方式で送信するコンテンツは権利瑕疵があり、または第三者の法的権利（特許権、商標権、著作権および著作隣接権、肖像権、プライバシー権、名誉権等を含むがこの限りではない）のを侵害することにより、SwitchBotおよびSwitchBotの関連会社がクレーム、検挙、事情聴取、弁償、訴訟等をなされた場合、またはSwitchBotおよびSwitchBotの関連会社が名誉、信用、財産の損失をなされる場合、ユーザーはSwitchBotおよびSwitchBotの関連会社が上述するクレームや訴訟に影響されないため、積極的にあらゆる手段を講じるべきものとします。ユーザーは、SwitchBotおよびSwitchBotの関連会社が被った直接的および間接的なの経済的損失について、一切の責任を負うものとします。

3.2.6 ユーザーは、サードパーティーサービスを悪用してはいけません。本サービスを通じてアップロード、投稿、メッセージの送信、メール、ほかの方式で送信するコンテンツを公的または私的な送信を問わず、コンテンツの提供者、使用者がアップロード、使用に対して自己責任を負うものとします。サードパーティーサービスは、情報保存サービスプラットフォームとして、本サービスを通じて配信される内容を管理することはできず、またユーザーの利用を全面的に制限することもできないため、コンテンツの合法性、正確性、完全性、信憑性、品質を保証することはできません。ユーザーは、本サービスを利用する際に、攻撃的または不適切な内容にさらされる可能性を理解し、サードパーティーサービスに依存することなく、自己の判断とあらゆるリスクを負うことに同意するものとします。

3.2.7 SwitchBotは、ユーザーによるサードパーティーサービスの利用が当社またはユーザーの国・地域の関連法規に適合していないことが通知または·により判明した場合、独自の判断により、ユーザーに事前に通知することなく直ちにユーザーに対するサービスの一部または全部の提供を中止し、かつ、ユーザーの不正行為による影響を軽減するために、ユーザーに是正を求め、または当社が必要と判断する措置（ユーザーがアップロードするコンテンツを変更または削除、サードパーティーサービス利用権の停止または終了を含むが、この限りではない）を直接講じる権利を有します。ユーザーがサードパーティーサービスを通じて、反動、ポルノ、国・地域の法令に違反するその他のコンテンツをアップロード・配布した場合、サードパーティーサービスのシステム記録がユーザーの法令違反の証拠として使用される場合があります。ユーザーがサードパーティーサービスを通じて上記コンテンツをアップロード・配布により、第三者からクレーム等の請求、またはそれに起因する損害について、ユーザーが自己の責任を負うものとします。
...
6.3　ユーザーが第三者（第三者のアプリケーションを含む）をサードパーティーサービスの内容へのアクセス/利用を許可することによって生じた紛争、損失等について当社は一切責任を負わないものとします。
...
(7) サードパーティーサービスに接続するためのネットワーク回線の不具合
...
---
### SwitchBot見守りカメラ3MPはネットに接続できなくなりました、どうしたらいいですか。

適用製品：

SwitchBot Pan/Tilt Cam 3MP
...
---
### SwitchBot見守りカメラ3MPを追加する時にWi-Fiに接続できない場合はどうすればよいですか?

対象製品：SwitchBot見守りカメラ 3MP
...
---
### カメラ3MPのマイクを使う時にハウリングします、これは正常ですか。
...
---
### カメラ3MPは電源が入らなくなりました、どうしたらいいでしょうか。
...
---
### 見守りカメラ3MPがSwitchBot のQR コードをスキャンできない場合は？
...
---
### 見守りカメラ3MPが「追加失敗」と表示される場合はどうすればよいですか?
...
---
### 見守りカメラ3MPのインジケーターは取り付ける際に、赤く速い点滅状態にならないのですが？

対象製品：SwitchBot見守りカメラ3MP
...
---
### 見守りカメラ3MPの画面を下に移動する時、本体内部を撮ってしまう
...
2．見守りカメラ3MPはSwitchBotアプリに追加され、ファームウェアバージョンは最新バージョンであることをご確認ください。

※ファームウェアバージョンの確認方法：SwitchBotアプリを開く‐確認したいデバイスをタップ‐右上の歯車アイコンをタップ‐ファームウェアバージョンをタップ

3．WiFiは2.4GHz（802.11b/g/n 、IPV4、WiFi4）に設定されたことをご確認ください。見守りカメラ3MPは5GHzのWiFiに対応できません。
...
---
### 見守りカメラ3MPはオフラインになってしまいました、どうしたらいいですか。
...
---
### SwitchBot 見守りカメラ3MPの初期化/リセット方法
...
SwitchBotカメラ3MPシリーズは画面の方向を変更可能となります。
...
動体追跡ボタンを押すと、動体検出されるとカメラは動体を追跡して上下左右(垂直115度、水平360度)動きます。(見守りカメラ3MPのみ)
...
---
### プライバシーモードになっている見守りカメラ3MPのWi-Fi再設定方法
...
．プライバシーモードになっている見守りカメラ3MPのWi-Fi再設定方法を案内いたします。
...
Wi-Fi再設定して別のアカウントに見守りカメラ3MPに入れたい場合、まず現在のアカウントからデバイスの削除をお願いいたします。セキュリティ観点からカメラ製品は一つのアカウントにしか追加できません。



---
### ホーム参加者に見守りカメラ3MPのみ共有したいです、どうしたらいいでしょうか。
...
---
### 見守りカメラ3MPの「お気に入り」とプリセットポイントについて
...
---
### 見守りカメラ3MPの動体検出プッシュ通知をオン/オフにする方法
...
3．SwitchBotアプリ→該当見守りカメラ3MP→歯車マーク→動体検出→動体検出を有効にします。

4．通知センターで見守りカメラ3MPの動体検出プッシュ通知をオンにする方法を案内いたします。
...
(複数ホームある場合)左上で該当見守りカメラ3MPのあるホームに切り替わります。
...
検出アラートが機能するには見守りカメラ3MPの「動体検出」機能をオンにする必要があります。
...
---
### 見守りカメラ3MPにmicroSDカードの差し込み方-抜き方
...
---
### 見守りカメラ3MPはSDカードの容量を使い切った場合、録画が自動上書きされますか。
...
2．デフォルト通話モードは単方向モードとなり、該当見守りカメラ3MPをタップしてリアル動画画面まで進みます。マイクマークを押しながら、話します。(ボタンを押している間だけ通話できます)
...
---
### トラブルシューティング見守りカメラ3MPが頻繁にオフラインになってしまいます
...
---
### トラブルシューティング見守りカメラ3MPはずっと読み込み中となり、映像が見れない
...
---
### トラブルシューティング見守りカメラ3MPは急にオフラインになってしまい、再接続できない
...
---
### トラブルシューティング初期設定の追加で、見守りカメラ3MPがQRコードを読み込めない
...
---
### トラブルシューティング見守りカメラ3MPがWi-Fiに接続できなくて、SwitchBotアプリに追加できない
...
---
### トラブルシューティングスマートフォンをWi-Fiに接続すると映像が表示されますが、外出先から映像が確認できません。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
モバイルキャリアは楽天 (またはドコモ)でしたら、一部の地域でインターネット制限があるため、外からビデオストリームの取得に失敗する現象があります。楽天の場合、楽天モバイルアプリ内にて、データ高速モードをトグルオン/オフにして改善されるかご確認ください。
<img width="747" height="1280" alt="image" src="https://github.com/user-attachments/assets/b8e21f03-361b-43f1-9c82-645f4c091436" />


備考：
影響を受ける機種は、弊社の屋内カメラ、見守りカメラ、見守りカメラ3MP、屋外カメラ、および屋外カメラ3MPです。

---
### トラブルシューティング 見守りカメラ 3MPの映像が真っ暗です。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1. 見守りカメラ3MPはレンズが遮断物で覆われているか確認してください。
2. 見守りカメラ3MPの映る角度を変えて、画面が明るくなるかご確認ください。
3. SwitchBotアプリ→見守りカメラ 3MP→操作画面の「ナイトビジョン」がオンであるかご確認ください。手動でナイトビジョンをオート、もしくは、オフにして、改善されるかご確認ください。
4. 見守りカメラ3MPの電源を入れ直してください。
