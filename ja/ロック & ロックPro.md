...
」は、「きゅう」という読み方はアレクサに認識可能で、「く」は認識できかねます。「く」を使用しないようお願いいたします。
...
[引っかかり対策](https://support.switch-bot.com/hc/ja/articles/7911260542999)
...
3．ロックProはBluetooth通信デバイスですが、ハブシリーズ製品と併用して、クラウドサービスをオンにすると通知が来るように設定できます。クラウドサービスがオフのままだと、「通知を許可」項目はグレーアウトで、使用できかねます。

関連投稿：

[ロックProの遠隔施錠・解錠(ハブに接続する方法)](https://support.switch-bot.com/hc/ja/articles/20695154903575)

4．下記の順番でロックProの通知をオンにします。
...
必要に応じてドア解放/施錠済み/解錠済み/ドアの閉め忘れ/未施錠を有効にします。

5．ステップ4の設定で、ロックProに施錠や解錠や未施錠の時にスマートフォンに通知が来るようになります。
...
![Image](https://support.switch-bot.com/hc/article_attachments/12885198639127)

2．「通知を許可」をオンにされると以下の通知項目が自動的にオンにされます。各項目について説明させていただきます。

![Image](https://support.switch-bot.com/hc/article_attachments/12884277773463)
