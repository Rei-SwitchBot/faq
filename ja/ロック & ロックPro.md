...
現時点で、本機能の体験にはホワイトリストへの追加が必要です。

アフターサービスにて対応させていただきます。
...
ロックProをホームメンバーと共有している場合、ホーム所有者と管理者（ホワイトリストへの追加が必要）のスマートフォンで自動解錠のトリガーが可能ですが、メンバーとメンバー(制限付き)のスマートフォンでのトリガーに対応しません。
