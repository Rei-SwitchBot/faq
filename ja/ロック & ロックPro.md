...
---
### ロックをアプリに追加する時に「デバイスの初期化が完了してない」と言われた
...
※該当ロックを長押し→該当ロックを選択→削除ボタンをタップ→削除確認→削除完了
2．リセットが必要とのご案内が出てきたら、注文エビデンス(アマゾン/公式ホームページ/取扱店舗の注文履歴書)をアップロードしていただくようお願いいたします。アプリで正しく認識されると、ロックが自動的にバインド解除され、追加できるようになります。
3．万が一、アプリで正しく認識されない、もしくは、中古購入の場合、注文履歴書をもって、アフターサービスまでご連絡ください。
