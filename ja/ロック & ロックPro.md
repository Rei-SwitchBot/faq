...
1．現在、ロックPro専用の電池カバーは単独で販売しておりませんが、必要な場合、下記の内容をいただけるとアフターサービスにて手配可能です。
...
1．現在、ロックPro専用の金属プレートは単独で販売しておりませんが、必要な場合、下記の内容をいただけるとアフターサービスにて手配可能です。
...
現在、ロックPro専用の特殊サムターンホルダーは単独で販売しておりませんが、必要な場合、下記の内容をいただけるとアフターサービスにて手配可能です。
...
必要な場合、下記の内容をいただけるとアフターサービスにて手配可能です。
...
1．現在、ロック専用の金属プレートは単独で販売しておりませんが、必要な場合、下記の内容をいただけるとアフターサービスにて手配可能です。
...
ご注意：ロットによって、ロックの最新ファームウェアバージョンは7.0と7.5二つあり、いずれも最新で、使用上の違いはありません。V7.0の場合、V7.5にアップデートする必要がありません。V7.0より古い場合、お気軽にアフターサービスまでファームウェアの更新を依頼してください。
