...
4．ロックProのクラウドサービスをオンにした後、デバイスのBluetooth範囲外でもSwitchBotアプリでの施錠・解錠が可能になります。

SwitchBotアプリV9.0から、クラウドサービスを手動で有効にする必要がなくなります（クラウドサービス項目自体が削除されました）。ロックが

ハブ製品の近く（Bluetooth範囲内）に設置されれば、自動的にハブと接続されます。
