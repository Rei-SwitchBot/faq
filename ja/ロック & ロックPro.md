...
SwitchBot App バージョン：8.3 以降

1．バッテリー残量が20%以下になると低電力のプッシュ通知がきます(ハブと併用する場合)。

2．低電力時に、施錠・解錠すると、ロックの表示ランプが赤色に点灯して低電力のプロンプトトーンが鳴ります。

3．低電力のになると、早めに新しいCR123A 3V電池(2個)に交換してください。弊社

[公式ホームページ](https://www.switchbot.jp/products/cr123a-4p)

にてご購入いただけます

。

※電圧電流の不安定で、アラートで低電力通知されない/正常に動作しない可能性があり、解錠ができなくなると、締め出される恐れがございますので、ニッケル水素充電池のご利用をご遠慮ください。
