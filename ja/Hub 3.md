...
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
ハブ3をWi-Fi ルーターのより近い位置（5メートル以内）に設置してください。
Wi-Fiルーターとハブ3の電源を抜いて、再起動してください。
デバイスの近くで、SwitchBotアプリ→ハブ3→歯車マーク→Wi-Fi設定の順番で、再度Wi-Fiを設定してください。
ご利用のハブ3のファームウェアが最新バージョンであることをご確認ください。SwitchBotアプリ→ハブ3→歯車マーク→ファームウェア＆バッテリーの順番でデバイスの近くでアップデートお願いいたします。
決まった時間でデバイスがオフラインになる場合、Wi-Fiルーター基本設定→設定→IPV4→DHCP→期限なしの順番でDHCPを期限なしに設定して改善されるかご確認ください。
ご自宅のWi-Fiルーターは5GHz/2.4GHz周波数両方とも対応なら、2.4GHzネットワークに接続してください。
...
※SwitchBotアプリ→該当ハブ3を長押し→該当ハブ3を選択→削除ボタンをタップ→削除確認→削除完了
...
---
### トラブルシューティングHub 3の画面に表示されている時間は、実際の時刻より一時間遅れている。

お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
本件について、以下をご確認いただけますでしょうか。
1. ご指摘いただいた内容はサマータイムの切り替えによる自動更新が行われていない可能性が高いと考えられます。すでにファームウェアにて修復されております。SwitchBotアプリ→ハブ3→歯車マーク→ファームウェア&バッテリーの順番で、更新可能なファームウェアバージョンがあるかご確認ください。必要であれば、デバイスの近くでファームウェアを最新バージョンにアップデートしてください。
*新しいファームウェアがまだ届いていない場合は、後ほど担当者より手配いたしますので、そのまましばらくお待ちください。
2. ファームウェアを最新に更新しても改善されない場合、SwitchBotアプリ→右下のプロフィール→ホームを管理→該当デバイスが追加しているホーム→ホームの位置を再設定してください。
