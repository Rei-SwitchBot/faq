...
[https://support.switch-bot.com/hc/ja/articles/360038240833](https://support.switch-bot.com/hc/ja/articles/360038240833)
...
ご注意：
同じホーム内にあるハブ製品の赤外線リモコンは、移行とコピーが可能です。異なるホームに所属するハブの場合は、まずハブを同じホームに移動してから赤外線リモコンの移行を行ってください。
...
1. ハブミニ自体はAlexaやGoogle Assistantなどのアプリから操作することがなくて、アマゾンアレクサアプリとGoogle Homeアプリでデバイスとして表示されません。ご了承お願いいたします。
2. ハブミニに自動学習/手動学習/ボタン学習で登録済みの赤外線リモコンはAlexaまたGoogle Assistantからの音声操作が可能です。アレクサアプリとの連携方法を案内いたします。
A. ハブミニで赤外線リモコンを登録してください。
リモコン登録方法：https://support.switch-bot.com/hc/ja/articles/360038240833
B. 方法1 下記の順番通りでアレクサアプリから連携するようお願いいたします。
...
C. 方法2 下記の順番通りでSwitchBotアプリから連携するようお願いいたします。
- SwitchBotアプリを起動し、ログインします。
- 学習済みの赤外線リモコン、もしくは、アカウントにあるハブミニ以外のデバイスをタップします。
- 右上にある歯車マークをタップします。
- 設定画面にある「サードパーティーサービス」をタップします。
- Amazon Alexaをタップします。
- 「連携へ」をタップします。
...
1. ハブミニ自体はAlexaやGoogle Assistantなどのアプリから操作することがなくて、アマゾンアレクサアプリとGoogle Homeアプリでデバイスとして表示されません。ご了承お願いいたします。
2. ハブミニに自動学習/手動学習/ボタン学習で登録済みの赤外線リモコンはAlexaまたGoogle Assistantからの音声操作が可能です。Google Homeとの連携方法を案内いたします。
A. ハブミニで赤外線リモコンを登録してください。
リモコン登録方法：https://support.switch-bot.com/hc/ja/articles/360038240833
B. 方法1 Google HomeアプリからSwitchBotアカウントをリンクします。
- Google Homeを開く。
...
出力5V1Aもしくは5V2Aで、接続端子はMicro USBの充電アダプターとケーブルをハブミニに使用するようお願いいたします。

ご注意：
1. 5V1Aより電圧電流の低い充電器を使ってしまうと、電圧/電流不足で、ネットワーク接続が不安定になる可能性があり、登録済みのリモコン/シーンが反応しなくなることがございます。
2. 5V2Aより電圧電流の高い充電器を使ってしまうと、ハブミニ自体が発熱して、焼けてしまう恐れがございます。ご遠慮ください。
3. 最新の生産ロットより、ハブミニの充電ポートがType-C仕様に変更されています。在庫状況によって、お届けするハブミニの充電ポートがType-CとMicro USBのいずれかになる場合がございます。いずれの仕様でも機能面での違いは一切ございませんので、どうぞご安心くださいませ。
