...
---
### トラブルシューティングカーペット上で使っているロボット掃除機K10+が充電ステーションに帰還しない
...
お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
ロボット掃除機K10+はサイドブラシ異物混入エラーで運転しない件について、以下をご確認いただけますでしょうか。
1．サイドブラシを取り外して手動でクリーニングしてください。
2．サイドブラシ抜きでロボットはエラーなく、運転できるかご確認ください。問題なく運転可能な場合、サイドブラシの交換をお願いいたします。
...
お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
ロボット掃除機異臭の件について、以下をご確認いただけますでしょうか。
1．ご自宅の電圧は110Vであることをご確認ください。規格以上の電圧であるとロボット掃除機が焼けてしまうことが生じてしまいます。
2．ロボット掃除機K10+はゴミ収集できるかご確認ください。ゴミ収集できる場合、ダストボックス、メインブラシとフィルターの掃除とダストパックの交換をしてから改善されるかご確認お願い致します。
...
お問い合わせいただき、ありがとうございます。
弊社の製品で大変ご迷惑をおかけしております。
ロボット掃除機K10+ゴミ収集の音がするがゴミが実際収集されていない件について、以下をご確認いただけますでしょうか。
1. ダストボックスを掃除してください。
2. 自動ごみ収集ベースを翻して吸引通路にゴミで詰まっているかご確認ください。必要に応じて、自動ごみ収集ベースの吸引通路をクリーニングしてください。
ごみ収集ステーション底部のネジを外してロボット掃除機K10+の吸引通路を掃除する動画を案内します。
動画：[https://youtu.be/KSgSbyqlNEI](https://www.youtube.com/watch?v=KSgSbyqlNEI)

<img width="960" height="1280" alt="image" src="https://github.com/user-attachments/assets/aa0a4380-aba9-4579-ab97-ec710bab575e" />
