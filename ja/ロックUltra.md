...
2. オート解錠機能を使用していない場合、SwitchBotアプリ→ロックUltra→歯車マーク→ファームウェア&バッテリーの順番で、更新可能なファームウェアバージョンがあるかご確認ください。必要であれば、デバイスの近くでファームウェアを最新バージョンにアップデートしてください。ファームウェアのアップデートが完了しましたら、ロックUltraを再校正（施錠・解錠位置の再記録）してからご使用ください。
