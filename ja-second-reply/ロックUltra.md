...
弊社の製品でご迷惑をおかけしたこと、再度お詫び申し上げます。
高さ調節パーツが必要な場合、アフターサービスにて手配可能か判断させていただ来ます。以下の情報をご提供いただけますでしょうか。
ご注文番号
ご購入履歴のスクリーンショット
送り先情報
お名前
...
弊社の製品でご迷惑をおかけしたこと、再度お詫び申し上げます。
ロックUltra本体の裏側ネジを外さないと、高さ調節スペーサーを使用できないため、本体の交換が必要です。より早めに手配するために、以下の情報をご提供いただけますでしょうか。
- ご注文番号
- ご購入履歴のスクリーンショット
- 送り先情報
1. お名前
...
弊社の製品でご迷惑をおかけしたこと、再度お詫び申し上げます。
弊社の技術チームにて本件を調査させていただきますので、以下の内容をいただけると助かります。
- ツインロックに設定失敗のエラースクリーンショット、もしくは、動画
...
※最新の操作ログを確認するため、(操作が失敗しても構いません) SwitchBotアプリ開き、ロックUltraをタップし、操作画面で一回施錠・解錠を行ってから、フィードバック提出をご協力お願いいたします。
...
***なお、緊急解錠でロックUltraが回転できる場合、本件を弊社の開発部にエスカレーションして調査させていただきます。そのまましばらくお待ちください。***

---
### トラブルシューティング ロックUltraを取り付けようとしたが、ロックUltra本体はドア枠と干渉して取り付けできません。

弊社の製品でご迷惑をおかけしたこと、再度お詫び申し上げます。
担当者より対応させていただきますので、以下のリンクをご確認の上で、ご自宅の玄関錠の写真と必要なサイズ情報をご協力お願いいたします。
...
弊社の製品でご迷惑をおかけしたこと、再度お詫び申し上げます。
弊社の技術チームにて本件を調査させていただきますので、以下の内容をいただけると助かります。
- SwitchBotアプリを開き、ロックUltra操作画面でロックUltraを操作して、引っかかって、施錠・解錠できない動画
- SwitchBotアプリでロックUltraの施錠（もしくは解錠）を操作した直後にフィードバックを再度提出
- 該当症状が発生した時間
...
弊社の製品でご迷惑をおかけしたこと、再度お詫び申し上げます。
パーツの再発送が必要か判断させていただきますので、以下の内容をいただけると助かります。
- ロックUltra内部のオレンジ部分を押しても戻らない状態がわかる動画

また、万が一発送が必要な場合、より早めに手配するために、以下の情報をご提供いただけますでしょうか。
- ご注文番号
- ご購入履歴のスクリーンショット
- 送り先情報
1. お名前
